...
define("vs/language/json/jsonMode", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var Te = e => X(e, "__esModule", { value: !0 });
    var xn = (e =>
    ...
    var En = (e, t) => () => (
      ...
      _n = (e, t) => {
        for (var i in t) X(e, i, { get: t[i], enumerable: !0 });
      },
      Y = (e, t, i, r) => {
    ...
    function Vn(e) {
      ...
      for (let i in e.changes) {
        ...
        for (let n of e.changes[i])
          t.push({ resource: r, edit: { range: C(n.range), text: n.newText } });
      }
      return { edits: t };
    }
    var oe = class {
    ...
    function ur(e, t, i, r = 0) {
      ...
      for (;;) {
        ...
        (h.endState = new j(i.getStateData(), o.getTokenError(), u, c)),
          h.tokens.push({ startIndex: p, scopes: d });
      }
      return h;
    }
