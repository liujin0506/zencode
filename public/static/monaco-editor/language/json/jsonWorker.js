...
define("vs/language/json/jsonWorker", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var Zr = t => ct(t, "__esModule", { value: !0 });
    var Qr = (t, r) => {
        for (var i in r) ct(t, i, { get: r[i], enumerable: !0 });
      },
      Yr = (t, r, i, e) => {
    ...
    var Kr = (t => (r, i) =>
      (t && t.get(r)) || ((i = Yr(Zr({}), r, 1)), t && t.set(r, i), i))(
      typeof WeakMap != "undefined" ? new WeakMap() : 0
    );
    var Hn = {};
    Qr(Hn, { JSONWorker: () => qt, create: () => _n });
    function Ce(t, r) {
      r === void 0 && (r = !1);
      var i = t.length,
        e = 0,
      ...
      function m() {
        ...
        if (e < t.length && t.charCodeAt(e) === 46)
          if ((e++, e < t.length && Oe(t.charCodeAt(e))))
...
`)),
        ...
        switch (v) {
          ...
          case 47:
            ...
            if (t.charCodeAt(e + 1) === 47) {
              for (e += 2; e < i && !Fe(t.charCodeAt(e)); ) e++;
    ...
    function gt(t, r, i) {
      var e, n, a, s, o;
      if (r) {
        for (s = r.offset, o = s + r.length, a = s; a > 0 && !dt(t, a - 1); )
          a--;
        for (var f = o; f < t.length && !dt(t, f); ) f++;
        (n = t.substring(a, f)), (e = tn(n, i));
      } else (n = t), (e = 0), (a = 0), (s = 0), (o = t.length);
      var l = rn(i, t),
        u = !1,
        c = 0,
        h;
      i.insertSpaces ? (h = ht(" ", i.tabSize || 4)) : (h = "	");
      var g = Ce(n, !1),
        m = !1;
      function p() {
        return l + ht(h, e + c);
      ...
      function y(N, L, R) {
        !m &&
          (!r || (L < o && R > s)) &&
          t.substring(L, R) !== N &&
          b.push({ offset: L, length: R - L, content: N });
      }
      var v = d();
      if (v !== 17) {
...
`.indexOf(t.charAt(r)) !== -1
      ...
      function i(e) {
        ...
        return (
          ...
          (x.undefined(a.relatedInformation) ||
            x.typedArray(a.relatedInformation, St.is))
        );
      }
      t.is = i;
    })(ae || (ae = {}));
    ...
    (function(t) {
      ...
      function n(a) {
        var s = a;
        return Y.is(s) && (Ie.is(s.annotationId) || X.is(s.annotationId));
      }
      t.is = n;
    })(me || (me = {}));
    var Le;
    ...
    (function(t) {
      ...
      function i(e) {
        ...
        return (
          x.defined(n) &&
          U.is(n.range) &&
          (x.undefined(n.command) || Ee.is(n.command))
        );
      }
      t.is = i;
    })(mr || (mr = {}));
...
` &&
    ...
    (function(t) {
      function r(n, a, s, o) {
        return new Ne(n, a, s, o);
      }
      t.create = r;
      function i(n, a, s) {
        if (n instanceof Ne) return n.update(a, s), n;
        throw new Error(
    ...
    function _(t, r, i, e) {
      ...
      function a() {
        function u(L) {
          return (
            n.type === L ||
            (L === "integer" && n.type === "number" && n.isInteger)
          );
        }
        if (
        ...
        var O = function(L, R) {
          for (var H = [], q = void 0, T = 0, S = L; T < S.length; T++) {
            var k = S[T],
              ...
              V = new te(),
              $ = e.newSub();
            if ((_(n, I, V, $), V.hasProblems() || H.push(I), !q))
              q = { schema: I, validationResult: V, matchingSchemas: $ };
            else if (
              !R &&
              !V.hasProblems() &&
              ...
              J > 0
                ...
                : J === 0 &&
                  (q.matchingSchemas.merge($),
                  q.validationResult.mergeEnumValues(V));
            }
          }
          return (
            H.length > 1 &&
        ...
        if ((A && j(A, K(r.then), K(r.else)), Array.isArray(r.enum))) {
          for (var P = ge(n), w = !1, C = 0, F = r.enum; C < F.length; C++) {
            var N = F[C];
            if (Pe(P, N)) {
              w = !0;
              break;
        ...
        function p(C) {
          ...
          return (
            N && {
              ...
              multiplier:
                (((F = N[2]) === null || F === void 0 ? void 0 : F.length) ||
                  0) - (parseInt(N[3]) || 0)
            }
          );
        }
      ...
      function f(u, c, h, g) {
        ...
        if (P) {
          var w = u.items.some(function(N) {
            var L = new te();
            return _(N, P, L, Vt.instance), !L.hasProblems();
          });
          w ||
            h.problems.push({
              location: { offset: u.offset, length: u.length },
      ...
      function l(u, c, h, g) {
        ...
        var w = function(Gt) {
          for (var ut = p.indexOf(Gt); ut >= 0; )
            p.splice(ut, 1), (ut = p.indexOf(Gt));
        };
        if (c.properties)
          for (var C = 0, F = Object.keys(c.properties); C < F.length; C++) {
            ...
            if (L)
              if (ie(N))
                ...
                var R = new te();
                _(L, N, R, g), h.mergePropertyMatch(R);
              }
          }
        ...
        if (typeof c.additionalProperties == "object")
          for (var V = 0, $ = p; V < $.length; V++) {
            ...
            if (L) {
              var R = new te();
              _(L, c.additionalProperties, R, g), h.mergePropertyMatch(R);
            }
          }
        ...
        if (
          ...
          for (
            ...
            if (ke) {
              ...
              if (Array.isArray(ce))
                for (var st = 0, zt = ce; st < zt.length; st++) {
                  var Bt = zt[st];
                  m[Bt]
        ...
        if (_t)
          for (var ft = 0, Ht = u.properties; ft < Ht.length; ft++) {
            var _r = Ht[ft],
              v = _r.keyNode;
            v && _(v, _t, h, Vt.instance);
          }
      }
    }
    function Or(t, r) {
      ...
      var m = new Lt(void 0, 0, 0);
      function p(A, P) {
        var w = new bn(A, a.getTokenOffset(), m),
          C = b(w);
        if (!C)
          if (a.getToken() === 16) {
            u(
            ...
            var F = new Lt(w, a.getTokenOffset(), a.getTokenLength());
      ...
      function d(A) {
        if (a.getToken() === 1) {
          var P = new xn(A, a.getTokenOffset()),
      ...
      function b(A) {
        if (a.getToken() === 10) {
          var P = new Lt(A, a.getTokenOffset());
          return (P.value = a.getTokenValue()), h(P, !0);
        }
      }
      function y(A) {
        if (a.getToken() === 11) {
          var P = new yn(A, a.getTokenOffset());
      ...
      function v(A) {
        ...
        switch (a.getToken()) {
          case 7:
            return h(new mn(A, a.getTokenOffset()), !0);
          case 8:
                ...
                add: function(d) {
                  ...
                  if (y)
                    ...
                    c &&
                      ...
                      g &&
                        (d.commitCharacters = d.kind === Q.Property ? wn : An),
                      (d.label = b),
                      (m[b] = d),
                      a.items.push(d);
                  }
              ...
              .then(function(d) {
                ...
                if (f && f.type === "object") {
                  ...
                  n.contributions.forEach(function(C) {
                    var F = C.collectPropertyCompletions(
                      r.uri,
                      P,
                      u,
                      y,
          ...
          (t.prototype.addDefaultValueCompletions = function(r, i, e, n) {
            ...
            if (se(r.default)) {
              ...
              e.add({
                ...
                insertTextFormat: z.Snippet,
                detail: $t("json.suggest.default", "Default value")
              }),
                (s = !0);
            }
          ...
          (t.prototype.addFillerValueCompletions = function(r, i, e) {
            r.object &&
              e.add({
                ...
                insertTextFormat: z.Snippet,
                detail: $t("defaults.object", "New object"),
                documentation: ""
              }),
              r.array &&
                e.add({
                  ...
                  insertText: this.getInsertTextForGuessedValue([], i),
                  insertTextFormat: z.Snippet,
                  detail: $t("defaults.array", "New array"),
                  documentation: ""
                });
          }),
                  ...
                  if (
                    ...
                    E.schema.markdownEnumDescriptions
                      ...
                      : E.schema.enumDescriptions &&
                        (y = Rt(E.schema.enumDescriptions[j])),
                      y &&
                        ((v = E.schema.enum[j]),
...
$3`
      ...
      Ir = (function() {
        ...
        return (
          ...
          (t.prototype.doValidation = function(r, i, e, n) {
            ...
            if (n) {
              var u = n.id || "schemaservice://untitled/" + On++,
          ...
          (t.prototype.getLanguageStatus = function(r, i) {
            return {
              schemas: this.jsonSchemaService.getSchemaURIsForResource(r.uri, i)
            };
          }),
          t
        );
    ...
    function B(t) {
      return t < Nr
        ...
        : t <= Cn
        ? t - Nr
        : (t < rt && (t += rt - Pn), t >= rt && t <= In ? t - rt + 10 : 0);
    }
    function Mr(t) {
      if (t[0] === "#")
        switch (t.length) {
          ...
          447: (e, n, a) => {
            ...
            var p = "",
              ...
              E =
                ...
                l);
            function j(T, S) {
              for (var k = void 0, I = -1, V = 0; V < T.length; V++) {
                var $ = T.charCodeAt(V);
                if (
                  ($ >= 97 && $ <= 122) ||
                  ($ >= 65 && $ <= 90) ||
                  ...
                  I !== -1 &&
                    ((k += encodeURIComponent(T.substring(I, V))), (I = -1)),
                  ...
                  J !== void 0
                    ? (I !== -1 &&
                        ((k += encodeURIComponent(T.substring(I, V))),
                        (I = -1)),
                      (k += J))
                    : I === -1 && (I = V);
                }
              ...
              if (
                ...
                if (ne !== -1) {
                  ...
                  ($ = $.substr(ne + 1)),
                    (ne = ke.indexOf(":")) === -1
                      ? (I += k(ke, !1))
                      : ((I += k(ke.substr(0, ne), !1)),
                        (I += ":"),
                        (I += k(ke.substr(ne + 1), !1))),
                    (I += "@");
                }
                (ne = ($ = $.toLowerCase()).indexOf(":")) === -1
                  ? (I += k($, !1))
                  : ((I += k($.substr(0, ne), !1)), (I += $.substr(ne)));
              }
              if (J) {
                if (
                  J.length >= 3 &&
            ...
            var L,
              ...
              H = function(T, S, k) {
                if (k || arguments.length === 2)
                  for (var I, V = 0, $ = S.length; V < $; V++)
                    (!I && V in S) ||
                      (I || (I = Array.prototype.slice.call(S, 0, V)),
                      (I[V] = S[V]));
        ...
        function t(r, i) {
          ...
          try {
            for (var e = 0, n = r; e < n.length; e++) {
              ...
              s || (a = a.substring(1)),
                a.length > 0 &&
                  (a[0] === Nn && (a = a.substring(1)),
                  this.globWrappers.push({
                    regexp: Dr("**/" + a, { extended: !0, globstar: !0 }),
                    include: s
                  }));
            }
            this.uris = i;
    ...
    function Wr(t, r, i) {
      function e(o) {
        ...
        for (var m = void 0, p = u.length - 1; p >= 0; p--)
          m = je.create(u[p], m);
        return m || (m = je.create(U.create(o, o))), m;
      }
      function n(o, f) {
      ...
      return {
        ...
        format: function(o, f, l) {
          ...
          var g = {
            ...
            insertFinalNewline:
              (l == null ? void 0 : l.insertFinalNewline) === !0,
            eol: `
`
          };
    ...
    function Br(t) {
      ...
      for (let e of t)
        e.length === 0 ||
          (e.length === 1 && e.charCodeAt(0) === Jt) ||
          (e.length === 2 && e.charCodeAt(0) === Jt && e.charCodeAt(1) === Jt
            ? r.pop()
            : r.push(e));
