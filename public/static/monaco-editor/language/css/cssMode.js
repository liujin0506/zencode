...
define("vs/language/css/cssMode", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var le = n => K(n, "__esModule", { value: !0 });
    var sn = (n =>
    ...
    var an = (n, t) => () => (
      ...
      un = (n, t) => {
        for (var i in t) K(n, i, { get: t[i], enumerable: !0 });
      },
      U = (n, t, i, r) => {
      ...
      dn = (n => (t, i) =>
        (n && n.get(t)) || ((i = U(le({}), t, 1)), n && n.set(t, i), i))(
        typeof WeakMap != "undefined" ? new WeakMap() : 0
      );
    var pe = an((Pn, fe) => {
      var cn = ge(sn("vs/editor/editor.api"));
      fe.exports = cn;
    });
    var En = {};
    un(En, {
      ...
      DefinitionAdapter: () => J,
      DiagnosticsAdapter: () => $,
      DocumentColorAdapter: () => ne,
      DocumentFormattingEditProvider: () => Qe,
      DocumentHighlightAdapter: () => G,
      DocumentLinkAdapter: () => qe,
      DocumentRangeFormattingEditProvider: () => Ge,
      DocumentSymbolAdapter: () => ee,
      FoldingRangeAdapter: () => te,
      HoverAdapter: () => Q,
      ReferenceAdapter: () => Y,
      RenameAdapter: () => Z,
      SelectionRangeAdapter: () => re,
      WorkerManager: () => W,
      fromPosition: () => _,
      fromRange: () => de,
      setupMode: () => wn,
    ...
    (function(n) {
      function t(r, e) {
        return (
          r === Number.MAX_VALUE && (r = O.MAX_VALUE),
    ...
    (function(n) {
      ...
      function e(o) {
        var s = o;
        return C.is(s) && (E.is(s.annotationId) || y.is(s.annotationId));
      }
      n.is = e;
    })(I || (I = {}));
    var V;
    (function(n) {
      ...
      function i(r) {
        var e = r;
        return a.defined(e) && z.is(e.textDocument) && Array.isArray(e.edits);
      }
      n.is = i;
    })(V || (V = {}));
    var L;
        ...
        return (
          ...
          (r.documentChanges === void 0 ||
            r.documentChanges.every(function(e) {
              return a.string(e.kind) ? L.is(e) || A.is(e) || F.is(e) : V.is(e);
            }))
        );
      }
      n.is = t;
            ...
            if (z.is(t)) {
              ...
              if (!r) {
                ...
                this._workspaceEdit.documentChanges.push(o),
                  (r = new j(e, this._changeAnnotations)),
    ...
    (function(n) {
      function t(i) {
        var r = i;
        return a.objectLiteral(i) && M.is(r.kind) && a.string(r.value);
      }
      n.is = t;
    })(ue || (ue = {}));
    var p;
    ...
    (function(n) {
      ...
      function i(r) {
        ...
        return (
          a.defined(e) &&
          a.typedArray(e.diagnostics, N.is) &&
    ...
    (function(n) {
      ...
      function i(r) {
        ...
        return (
          e &&
          a.string(e.title) &&
          (e.diagnostics === void 0 || a.typedArray(e.diagnostics, N.is)) &&
    ...
    (function(n) {
      ...
      function r(o, s) {
        for (
          var u = o.getText(),
            l = e(s, function(w, H) {
              var ce = w.range.start.line - H.range.start.line;
              return ce === 0
                ? w.range.start.character - H.range.start.character
                : ce;
            }),
            f = u.length,
            g = l.length - 1;
...
` &&
    ...
    (function(n) {
      ...
      n.number = s;
      function u(c, w, H) {
        return t.call(c) === "[object Number]" && w <= c && c <= H;
      }
      n.numberRange = u;
      function l(c) {
        return (
              ...
              f = s.items.map(g => {
                ...
                return (
                  ...
                  g.additionalTextEdits &&
                    (m.additionalTextEdits = g.additionalTextEdits.map(S)),
                  g.insertTextFormat === X.Snippet &&
                    (m.insertTextRules =
...
` +
    ...
    function In(n) {
      ...
      for (let i in n.changes) {
        ...
        for (let e of n.changes[i])
          t.push({ resource: r, edit: { range: T(e.range), text: e.newText } });
      }
      return { edits: t };
    }
    var ee = class {
      ...
      Ge = class {
        ...
        provideDocumentRangeFormattingEdits(t, i, r, e) {
          ...
          return this._worker(o).then(s =>
            s.format(o.toString(), de(i), Je(r)).then(u => {
              if (!(!u || u.length === 0)) return u.map(S);
            })
          );
        }
      };
    ...
    var ne = class {
        ...
        provideColorPresentations(t, i, r) {
          ...
          return this._worker(e)
            .then(o =>
              o.getColorPresentations(e.toString(), i.color, de(i.range))
            )
            .then(o => {
              if (!!o)
                return o.map(s => {
                  let u = { label: s.label };
                  return (
                    s.textEdit && (u.textEdit = S(s.textEdit)),
                    s.additionalTextEdits &&
                      (u.additionalTextEdits = s.additionalTextEdits.map(S)),
                    u
                  );
                });
            });
    ...
    function wn(n) {
      ...
      function o() {
        ...
        Ze(i),
          ...
          u.hovers && i.push(d.languages.registerHoverProvider(s, new Q(e))),
          u.documentHighlights &&
            i.push(d.languages.registerDocumentHighlightProvider(s, new G(e))),
          u.definitions &&
            i.push(d.languages.registerDefinitionProvider(s, new J(e))),
          u.references &&
            i.push(d.languages.registerReferenceProvider(s, new Y(e))),
          u.documentSymbols &&
            i.push(d.languages.registerDocumentSymbolProvider(s, new ee(e))),
          u.rename && i.push(d.languages.registerRenameProvider(s, new Z(e))),
          u.colors && i.push(d.languages.registerColorProvider(s, new ne(e))),
          u.foldingRanges &&
            i.push(d.languages.registerFoldingRangeProvider(s, new te(e))),
          u.diagnostics && i.push(new $(s, e, n.onDidChange)),
          u.selectionRanges &&
            i.push(d.languages.registerSelectionRangeProvider(s, new re(e)));
      }
