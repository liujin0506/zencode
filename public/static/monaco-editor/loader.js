...
(function(l) {
  ...
  var E = (function() {
    ...
    return (
      Object.defineProperty(v.prototype, "isWindows", {
        get: function() {
...
(function(l) {
  var E = (function() {
    function v() {}
    return (
      (v.fileUriToFilePath = function(g, a) {
      ...
      (v.recursiveClone = function(g) {
        ...
        return (
          v.forEachProperty(g, function(n, _) {
            _ && typeof _ == "object"
              ? (a[n] = v.recursiveClone(_))
              : (a[n] = _);
          }),
          a
        );
      ...
      (v.NEXT_ANONYMOUS_ID = 1),
      (v.PERFORMANCE_NOW_PROBED = !1),
      (v.HAS_PERFORMANCE_NOW = !1),
      v
    );
  })();
  l.Utilities = E;
...
(function(l) {
        ...
        return (
          l.Utilities.forEachProperty(n, function(e, t) {
            ...
            typeof s.ignoreDuplicateModules != "undefined"
              ...
              ? l.Utilities.forEachProperty(t, function(r, i) {
                  return (s.paths[r] = i);
                })
  ...
  var g = (function() {
    function a(n, _) {
      if (
        ((this._env = n),
        (this.options = v.mergeConfigurationOptions(_)),
    ...
    return (
      ...
      (a.prototype._createSortedPathsRules = function() {
        ...
        (this.sortedPathsRules = []),
          l.Utilities.forEachProperty(this.options.paths, function(_, s) {
            Array.isArray(s)
              ? n.sortedPathsRules.push({ from: _, to: s })
              : n.sortedPathsRules.push({ from: _, to: [s] });
          }),
      ...
      (a.prototype._applyPaths = function(n) {
        for (var _, s = 0, e = this.sortedPathsRules.length; s < e; s++)
          if (
            ((_ = this.sortedPathsRules[s]), l.Utilities.startsWith(n, _.from))
          ) {
            for (var t = [], r = 0, i = _.to.length; r < i; r++)
...
(function(l) {
  var E = (function() {
    ...
    v = (function() {
      function e() {}
      return (
        (e.prototype.attachListeners = function(t, r, i) {
          var o = function() {
        ...
        (e.prototype.load = function(t, r, i, o) {
          if (/^node\|/.test(r)) {
            var u = t.getConfig().getOptionsLiteral(),
              c = _(t.getRecorder(), u.nodeRequire || l.global.nodeRequire),
              f = r.split("|"),
              p = null;
            try {
              p = c(f[1]);
...
//# sourceURL=` +
    ...
    n = (function() {
      ...
      return (
        ...
        (e.prototype._initNodeRequire = function(t, r) {
          ...
          u.prototype._compile = function(f, p) {
            var d = u.wrap(f.replace(/^#!.*/, "")),
              y = r.getRecorder(),
              h = o._getCachedDataPath(i, p),
              m = { filename: p },
              P;
            try {
              var I = o._fs.readFileSync(h);
              (P = I.slice(0, 16)),
                (m.cachedData = I.slice(16)),
                y.record(60, h);
            } catch {
              y.record(61, h);
            }
            var b = new o._vm.Script(d, m),
              R = b.runInThisContext(m),
              U = o._path.dirname(p),
              w = c(this),
              O = [
                this.exports,
              ...
              C = R.apply(this.exports, O);
            return (
              o._handleCachedData(b, d, h, !m.cachedData, r),
              o._verifyCachedData(b, d, h, P, r),
              C
            );
          };
        }),
        (e.prototype.load = function(t, r, i, o) {
          var u = this,
            c = t.getConfig().getOptionsLiteral(),
            f = _(t.getRecorder(), c.nodeRequire || l.global.nodeRequire),
            p =
              c.nodeInstrumenter ||
              function(R) {
                return R;
          ...
          if (/^node\|/.test(r)) {
            ...
            var m = this._path.normalize(r),
              P = this._getElectronRendererScriptPathOrUri(m),
              I = Boolean(c.nodeCachedData),
              b = I ? this._getCachedDataPath(c.nodeCachedData, r) : void 0;
            this._readSourceAndCachedData(m, b, d, function(R, U, w, O) {
              ...
              U.charCodeAt(0) === e._BOM
                ...
                (C = p(C, m));
              var M = { filename: P, cachedData: w },
                N = u._createAndEvalScript(t, C, M, i, o);
              u._handleCachedData(N, C, b, I && !w, t),
        ...
        (e.prototype._createAndEvalScript = function(t, r, i, o, u) {
          ...
          var f = new this._vm.Script(r, i),
            p = f.runInThisContext(i),
          ...
          t.cachedDataRejected
            ? this._fs.unlink(i, function(f) {
                u.getRecorder().record(62, i),
                  c._createAndWriteCachedData(t, r, i, u),
            ...
            y = function() {
              setTimeout(function() {
                ...
                if (!(h.length === 0 || h.length === f || p >= 5)) {
                  ...
                  (f = h.length),
                    u._fs.writeFile(i, Buffer.concat([d, h]), function(m) {
                      m && o.getConfig().onError(m),
        ...
        (e.prototype._readSourceAndCachedData = function(t, r, i, o) {
          if (!r) this._fs.readFile(t, { encoding: "utf8" }, o);
          else {
            var u = void 0,
              c = void 0,
              f = void 0,
            ...
            this._fs.readFile(t, { encoding: "utf8" }, function(y, h) {
              ...
              this._fs.readFile(r, function(y, h) {
                !y && h && h.length > 0
                  ? ((f = h.slice(0, 16)), (c = h.slice(16)), i.record(60, r))
                  : i.record(61, r),
                  d();
              });
          }
    ...
    return (
      ...
      (s._invokeFactory = function(e, t, r, i) {
        return e.isBuild() && !l.Utilities.isAnonymousModule(t)
          ...
          : { returnedValue: r.apply(l.global, i), producedError: null };
      }),
        ...
        if (this._callback)
          if (typeof this._callback == "function") {
            ...
            (i = o.producedError),
              ...
              !i &&
                typeof o.returnedValue != "undefined" &&
                (!this.exportsPassedIn || l.Utilities.isEmpty(this.exports)) &&
                (this.exports = o.returnedValue);
  ...
  var _ = (function() {
    function s(e, t, r, i, o) {
      o === void 0 && (o = 0),
        ...
        (this._loaderAvailableTimestamp = o),
        (this._defineFunc = r),
        (this._requireFunc = i),
    ...
    return (
        ...
        for (
          ...
          if (c) {
            var f = c[1],
              p = c[2],
              d = c[3],
              y = Math.max(f.lastIndexOf(" ") + 1, f.lastIndexOf("(") + 1);
            if (((f = f.substr(y)), (f = r(f)), f === i)) {
              var h = { line: parseInt(p, 10), col: parseInt(d, 10) };
              return (
                h.line === 1 &&
                  (h.col -= "(function (require, define, __filename, __dirname) { ".length),
                h
              );
            }
          }
      ...
      (s.prototype.getBuildInfo = function() {
        ...
        for (var e = [], t = 0, r = 0, i = this._modules2.length; r < i; r++) {
          ...
          if (!!o) {
            var u = this._buildInfoPath[o.id] || null,
              c = this._buildInfoDefineStack[o.id] || null,
              f = this._buildInfoDependencies[o.id];
            e[t++] = {
              id: o.strId,
              path: u,
              defineLocation:
                u && c ? s._findRelevantLocationInStack(u, c) : null,
              dependencies: f,
              shim: null,
              exports: o.exports
            };
      ...
      (s.prototype.defineModule = function(e, t, r, i, o, u) {
        ...
        (this._modules2[f] = p),
          this._config.isBuild() &&
            ((this._buildInfoDefineStack[f] = o),
            (this._buildInfoDependencies[f] = (p.dependencies || []).map(
              function(d) {
      ...
      (s.prototype._normalizeDependency = function(e, t) {
        ...
        var r = e.indexOf("!");
        if (r >= 0) {
          var i = t.resolveModule(e.substr(0, r)),
            o = t.resolveModule(e.substr(r + 1)),
            u = this._moduleIdProvider.getModuleId(i + "!" + o),
            c = this._moduleIdProvider.getModuleId(i);
          return new n(u, c, o);
        }
        return new a(this._moduleIdProvider.getModuleId(t.resolveModule(e)));
      }),
      (s.prototype._normalizeDependencies = function(e, t) {
        for (var r = [], i = 0, o = 0, u = e.length; o < u; o++)
          r[i++] = this._normalizeDependency(e[o], t);
        return r;
      }),
      ...
      (s.prototype._createLoadError = function(e, t) {
        var r = this,
          i = this._moduleIdProvider.getStrModuleId(e),
      ...
      (s.prototype._onLoadError = function(e, t) {
        ...
        for (
          var i = [], o = 0, u = this._moduleIdProvider.getMaxModuleId();
          o < u;
          o++
        )
          i[o] = !1;
      ...
      (s.prototype._loadModule = function(e) {
        ...
        if (!(this._modules2[e] || this._knownModules2[e])) {
          ...
          var r = this._moduleIdProvider.getStrModuleId(e),
            ...
            o = /^@[^\/]+\/[^\/]+$/;
          this._env.isNode &&
            (r.indexOf("/") === -1 || o.test(r)) &&
            i.push("node|" + r);
          var u = -1,
            c = function(f) {
              if ((u++, u >= i.length)) t._onLoadError(e, f);
              else {
                var p = i[u],
                  d = t.getRecorder();
                if (t._config.isBuild() && p === "empty:") {
                  (t._buildInfoPath[e] = p),
                    t.defineModule(
                ...
                d.record(10, p),
                  t._scriptLoader.load(
                    ...
                    p,
                    function() {
                      t._config.isBuild() && (t._buildInfoPath[e] = p),
                        d.record(11, p),
                        t._onLoad(e);
                    },
                    function(y) {
...
`)
            ...
            if (
              ...
              d ||
                ((d = []), this._inversePluginDependencies2.set(u.pluginId, d)),
                d.push(u),
      ...
      (s.prototype._onModuleComplete = function(e) {
        ...
        if (!e.isComplete()) {
          ...
          if (((this._inverseDependencies2[e.id] = null), d))
            for (var u = 0, c = d.length; u < c; u++) {
              var y = d[u],
                h = this._modules2[y];
              h.unresolvedDependenciesCount--,
                h.unresolvedDependenciesCount === 0 &&
          ...
          if (m) {
            ...
            for (var u = 0, c = m.length; u < c; u++)
              this._loadPluginDependency(e.exports, m[u]);
          }
        }
      }),
      s
...
(function(l) {
  var E = new l.Environment(),
    ...
    g = function(s, e, t) {
      typeof s != "string" && ((t = e), (e = s), (s = null)),
        ...
        s
          ? v.defineModule(s, e, t, null, null)
          : v.enqueueDefineAnonymousModule(e, t);
    };
  g.amd = { jQuery: !0 };
  var a = function(s, e) {
    ...
    n = function() {
      if (arguments.length === 1) {
        ...
        if (typeof arguments[0] == "string")
          return v.synchronousRequire(arguments[0]);
      }
      if (
  ...
  (l.init = _),
    (typeof l.global.define != "function" || !l.global.define.amd) &&
      ...
      (define.amd = g.amd),
      typeof doNotInitLoader == "undefined" && _());
})(AMDLoader || (AMDLoader = {}));
