    ...
    var r = (function() {
      ...
      return (
        ...
        (E.endsWith = function(e, N) {
          return e.length >= N.length && e.substr(e.length - N.length) === N;
        }),
      ...
      return (
        (N.validateConfigurationOptions = function(o) {
          ...
          if (
            ...
            o.baseUrl.length > 0 &&
              (U.Utilities.endsWith(o.baseUrl, "/") || (o.baseUrl += "/")),
          ...
          return (
            U.Utilities.forEachProperty(o, function(c, m) {
              ...
              typeof g.ignoreDuplicateModules != "undefined"
                ? (g.ignoreDuplicateModules = g.ignoreDuplicateModules.concat(
                    m
                  ))
                : c === "paths" && typeof g.paths != "undefined"
                ? U.Utilities.forEachProperty(m, function(S, t) {
                    return (g.paths[S] = t);
                  })
                : c === "config" && typeof g.config != "undefined"
                ? U.Utilities.forEachProperty(m, function(S, t) {
                    return (g.config[S] = t);
                  })
    ...
    var e = (function() {
        ...
        if (
          ...
          if (
            ...
            var g = this.options.nodeRequire.main.filename,
              c = Math.max(g.lastIndexOf("/"), g.lastIndexOf("\\"));
      ...
      return (
        ...
        (N.prototype._createNodeModulesMap = function() {
          ...
          for (var o = 0, w = this.options.nodeModules; o < w.length; o++) {
            var g = w[o];
        ...
        (N.prototype._createSortedPathsRules = function() {
          ...
          (this.sortedPathsRules = []),
            U.Utilities.forEachProperty(this.options.paths, function(w, g) {
              Array.isArray(g)
                ? o.sortedPathsRules.push({ from: w, to: g })
                : o.sortedPathsRules.push({ from: w, to: [g] });
            }),
        ...
        (N.prototype.cloneAndMerge = function(o) {
          return new N(this._env, E.mergeConfigurationOptions(o, this.options));
        }),
        (N.prototype.getOptionsLiteral = function() {
          return this.options;
        }),
        (N.prototype._applyPaths = function(o) {
          for (var w, g = 0, c = this.sortedPathsRules.length; g < c; g++)
            if (
        ...
        (N.prototype.moduleIdToPaths = function(o) {
          if (this._env.isNode) {
            ...
            if (w) return this.isBuild() ? ["empty:"] : ["node|" + o];
          }
          var g = o,
            c;
          if (
        ...
        (N.prototype.requireToUrl = function(o) {
          ...
          return (
            U.Utilities.isAbsolutePath(w) ||
              ...
              U.Utilities.isAbsolutePath(w) || (w = this.options.baseUrl + w)),
          ...
          (c.prototype.load = function(m, S, t, d) {
            ...
            if (!this._scriptLoader)
              if (this._env.isWebWorker) this._scriptLoader = new N();
                ...
                var v = m.getConfig().getOptionsLiteral().preferScriptTags;
                v
      ...
      E = (function() {
        ...
        return (
          (c.prototype.attachListeners = function(m, S, t) {
            ...
            m.addEventListener("load", h), m.addEventListener("error", v);
          }),
          (c.prototype.load = function(m, S, t, d) {
            if (/^node\|/.test(S)) {
              var h = m.getConfig().getOptionsLiteral(),
                v = w(m.getRecorder(), h.nodeRequire || U.global.nodeRequire),
                L = S.split("|"),
                C = null;
              try {
                C = v(L[1]);
              ...
              p && (S = p.createScriptURL(S)), y.setAttribute("src", S);
        ...
        return (
          ...
          (c.prototype.load = function(m, S, t, d) {
            if (/^node\|/.test(S)) {
              ...
              var y = m.getConfig().getOptionsLiteral().trustedTypesPolicy,
                p =
                  /^((http:)|(https:)|(file:))/.test(S) &&
                  S.substring(0, self.origin.length) !== self.origin;
...
//# sourceURL=` +
              ...
              try {
                y && (S = y.createScriptURL(S)), importScripts(S), t();
              } catch (s) {
                d(s);
              }
            }
      ...
      o = (function() {
        ...
        return (
          ...
          (c.prototype._initNodeRequire = function(m, S) {
            var t = S.getConfig().getOptionsLiteral().nodeCachedData;
            ...
            h.prototype._compile = function(L, C) {
              ...
              var f = new d._vm.Script(y, i),
                ...
                _ = d._path.dirname(C),
                b = v(this),
                A = [this.exports, b, this, C, _, process, Se, Buffer],
          ...
          (c.prototype.load = function(m, S, t, d) {
            var h = this,
              ...
              L = w(m.getRecorder(), v.nodeRequire || U.global.nodeRequire),
              C =
                v.nodeInstrumenter ||
                function(u) {
                  return u;
            ...
            if (/^node\|/.test(S)) {
              ...
              S = U.Utilities.fileUriToFilePath(this._env.isWindows, S);
              var i = this._path.normalize(S),
                a = this._getElectronRendererScriptPathOrUri(i),
                l = Boolean(v.nodeCachedData),
                f = l ? this._getCachedDataPath(v.nodeCachedData, S) : void 0;
              this._readSourceAndCachedData(i, f, y, function(u, _, b, A) {
                if (u) {
                  d(u);
                  return;
                }
                ...
                _.charCodeAt(0) === c._BOM
                  ? (P = c._PREFIX + _.substring(1) + c._SUFFIX)
                  : (P = c._PREFIX + _ + c._SUFFIX),
                  (P = C(P, i));
                var D = { filename: a, cachedData: b },
                  k = h._createAndEvalScript(m, P, D, t, d);
                h._handleCachedData(k, P, f, l && !b, m),
                  h._verifyCachedData(k, P, f, A, m);
              });
            }
          }),
          (c.prototype._createAndEvalScript = function(m, S, t, d, h) {
            var v = m.getRecorder();
          ...
          (c.prototype._getElectronRendererScriptPathOrUri = function(m) {
            if (!this._env.isElectronRenderer) return m;
            var S = m.match(/^([a-z])\:(.*)/i);
            return S
              ? "file:///" +
                  (S[1].toUpperCase() + ":" + S[2]).replace(/\\/g, "/")
              : "file://" + m;
          }),
          ...
          (c.prototype._createAndWriteCachedData = function(m, S, t, d) {
            var h = this,
              v = Math.ceil(
                d.getConfig().getOptionsLiteral().nodeCachedData.writeDelay *
                  (1 + Math.random())
              ),
              L = -1,
              C = 0,
              ...
              p = function() {
                setTimeout(function() {
                  ...
                  if (!(s.length === 0 || s.length === L || C >= 5)) {
                    if (s.length < L) {
                      p();
                      return;
                    }
                    (L = s.length),
                      h._fs.writeFile(t, Buffer.concat([y, s]), function(i) {
                        i && d.getConfig().onError(i),
                          d.getRecorder().record(63, t),
                          p();
                      });
                  }
                }, v * Math.pow(4, C++));
          ...
          (c.prototype._readSourceAndCachedData = function(m, S, t, d) {
            if (!S) this._fs.readFile(m, { encoding: "utf8" }, d);
              ...
              this._fs.readFile(m, { encoding: "utf8" }, function(p, s) {
                (h = s), y(p);
              }),
                this._fs.readFile(S, function(p, s) {
                  !p && s && s.length > 0
                    ? ((L = s.slice(0, 16)), (v = s.slice(16)), t.record(60, S))
                    : t.record(61, S),
                    y();
                });
            }
          ...
          return (
            U.Utilities.isAbsolutePath(m) ||
              ((U.Utilities.startsWith(m, "./") ||
                U.Utilities.startsWith(m, "../")) &&
                (m = g._normalizeModuleId(this.fromModulePath + m))),
            m
          );
        }),
        (g.ROOT = new g("")),
    ...
    var E = (function() {
      ...
      return (
        (g._safeInvokeFunction = function(c, m) {
          try {
            return { returnedValue: c.apply(U.global, m), producedError: null };
          } catch (S) {
        ...
        (g._invokeFactory = function(c, m, S, t) {
          return c.isBuild() && !U.Utilities.isAnonymousModule(m)
            ...
            : { returnedValue: S.apply(U.global, t), producedError: null };
        }),
        (g.prototype.complete = function(c, m, S) {
          ...
          if (this._callback)
            if (typeof this._callback == "function") {
              ...
              var d = g._invokeFactory(m, this.strId, this._callback, S);
              (t = d.producedError),
    ...
    var w = (function() {
      ...
      return (
          ...
          for (
            ...
            if (v) {
              var L = v[1],
                C = v[2],
                y = v[3],
                p = Math.max(L.lastIndexOf(" ") + 1, L.lastIndexOf("(") + 1);
              if (((L = L.substr(p)), (L = S(L)), L === t)) {
                var s = { line: parseInt(C, 10), col: parseInt(y, 10) };
                return (
                  s.line === 1 &&
                    (s.col -= "(function (require, define, __filename, __dirname) { ".length),
                  s
                );
              }
            }
          ...
          for (
            ...
            if (!!d) {
              ...
              c[m++] = {
                ...
                path: h,
                defineLocation:
                  h && v ? g._findRelevantLocationInStack(h, v) : null,
                dependencies: L,
                shim: null,
                exports: d.exports
              };
        ...
        (g.prototype.defineModule = function(c, m, S, t, d, h) {
          ...
          var C = new E(L, c, this._normalizeDependencies(m, h), S, t, h);
          (this._modules2[L] = C),
            this._config.isBuild() &&
        ...
        (g.prototype._normalizeDependency = function(c, m) {
          ...
          return new N(this._moduleIdProvider.getModuleId(m.resolveModule(c)));
        }),
        ...
        (g.prototype._relativeRequire = function(c, m, S, t) {
          if (typeof m == "string") return this.synchronousRequire(m, c);
          this.defineModule(
        ...
        (g.prototype._createLoadError = function(c, m) {
          var S = this,
            ...
            d = (this._inverseDependencies2[c] || []).map(function(v) {
              return S._moduleIdProvider.getStrModuleId(v);
            }),
            h = U.ensureError(m);
          return (h.phase = "loading"), (h.moduleId = t), (h.neededBy = d), h;
        }),
        (g.prototype._onLoadError = function(c, m) {
          ...
          for (
            var t = [], d = 0, h = this._moduleIdProvider.getMaxModuleId();
            d < h;
            d++
          )
            t[d] = !1;
                ...
                if ((h++, h >= t.length)) m._onLoadError(c, L);
                  ...
                  if (m._config.isBuild() && C === "empty:") {
                    (m._buildInfoPath[c] = C),
                      m.defineModule(
                        m._moduleIdProvider.getStrModuleId(c),
                        [],
                        null,
                        null,
                        null
                  ...
                  y.record(10, C),
                    m._scriptLoader.load(
                      ...
                      C,
                      function() {
                        m._config.isBuild() && (m._buildInfoPath[c] = C),
                          y.record(11, C),
                          m._onLoad(c);
                      },
                      function(p) {
          ...
          if (S)
            for (var t = 0, d = S.length; t < d; t++) {
              ...
              if (this._hasDependencyPath(h.id, c.id)) {
                ...
                var L = this._findCyclePath(h.id, c.id, 0) || [];
                L.reverse(),
                  L.push(h.id),
                  console.warn(
                    L.map(function(p) {
                      return m._moduleIdProvider.getStrModuleId(p);
                    }).join(` => 
`)
                  ),
                  c.unresolvedDependenciesCount--;
              ...
              if (
                ...
                var y = this._inversePluginDependencies2.get(h.pluginId);
                y ||
                  ((y = []),
                  this._inversePluginDependencies2.set(h.pluginId, y)),
                  y.push(h),
              ...
              for (var h = 0, v = t.length; h < v; h++) {
                ...
                if (L === N.MODULE) {
                  d[h] = {
                    id: c.strId,
                    config: function() {
                      return m._config.getConfigForModule(c.strId);
                    }
                  };
                  continue;
                }
                if (L === N.REQUIRE) {
                  d[h] = this._createRequire(c.moduleIdResolver);
                  continue;
                }
  ...
  (function(U) {
    var r = new U.Environment(),
      ...
      e = function(g, c, m) {
        typeof g != "string" && ((m = c), (c = g), (g = null)),
          (typeof c != "object" || !Array.isArray(c)) && ((m = c), (c = null)),
    ...
    Y(Q[16], Z([0, 1]), function(U, r) {
      ...
      function N(R, I, F = (O, V) => O === V) {
        ...
        for (let O = 0, V = R.length; O < V; O++) if (!F(R[O], I[O])) return !1;
        return !0;
      }
      r.equals = N;
      function o(R, I, F) {
      ...
      function g(R, I, F) {
        if (((R = R | 0), R >= I.length)) throw new TypeError("invalid index");
      ...
      r.splice = f;
      function u(R, I) {
        return I < 0 ? Math.max(I + R.length, 0) : Math.min(I, R.length);
      }
      function _(R, I) {
      ...
      class k {
        ...
        takeWhile(I) {
          ...
          const O =
            F === this.firstIdx ? null : this.items.slice(this.firstIdx, F);
        ...
        takeCount(I) {
          const F = this.items.slice(this.firstIdx, this.firstIdx + I);
    ...
    Y(Q[17], Z([0, 1]), function(U, r) {
      ...
      class E {
        ...
        get(N) {
          ...
          return (
            this.lastArgKey !== o &&
              ((this.lastArgKey = o), (this.lastCache = this.computeFn(N))),
            this.lastCache
          );
        }
      }
    ...
    Y(Q[18], Z([0, 1]), function(U, r) {
      ...
      function E(o) {
        return o ? o.replace(/\$\((.*?)\)/g, (w, g) => ` ${g} `).trim() : "";
      }
    ...
    Y(Q[10], Z([0, 1]), function(U, r) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.NotSupportedError = r.illegalState = r.illegalArgument = r.canceled = r.CancellationError = r.isCancellationError = r.transformErrorForSerialization = r.onUnexpectedExternalError = r.onUnexpectedError = r.errorHandler = r.ErrorHandler = void 0);
      class E {
        constructor() {
          (this.listeners = []),
...
` +
    ...
    Y(Q[21], Z([0, 1]), function(U, r) {
      ...
      (function(e) {
        function N(a) {
          return (
            a && typeof a == "object" && typeof a[Symbol.iterator] == "function"
          );
        }
        e.is = N;
        ...
        function* p(a, l, f = a.length) {
          for (
            l < 0 && (l += a.length),
              f < 0 ? (f += a.length) : f > a.length && (f = a.length);
            l < f;
            l++
          )
            yield a[l];
    ...
    Y(Q[22], Z([0, 1]), function(U, r) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.KeyChord = r.KeyCodeUtils = r.IMMUTABLE_KEY_CODE_TO_CODE = r.IMMUTABLE_CODE_TO_KEY_CODE = r.NATIVE_WINDOWS_KEY_CODE_TO_KEY_CODE = r.EVENT_KEY_CODE_MAP = void 0);
      class E {
        constructor() {
      ...
      (function() {
        ...
        for (const L of d) {
          ...
          if (
            ...
            e.define(i, a), N.define(i, u || a), o.define(i, _ || u || a);
          }
    ...
    Y(Q[8], Z([0, 1, 20, 21]), function(U, r, E, e) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.ImmortalReference = r.SafeDisposable = r.MutableDisposable = r.Disposable = r.DisposableStore = r.toDisposable = r.combinedDisposable = r.dispose = r.isDisposable = r.MultiDisposeError = r.markAsSingleton = r.setDisposableTracker = void 0);
      const N = !1;
      let o = null;
      function w(l) {
        o = l;
      ...
      class y {
        constructor() {
          (this._toDispose = new Set()), (this._isDisposed = !1), g(this);
        }
        dispose() {
    ...
    Y(Q[24], Z([0, 1]), function(U, r) {
      ...
      class e {
        ...
        _insert(o, w) {
          const g = new E(o);
          if (this._first === E.Undefined) (this._first = g), (this._last = g);
          else if (w) {
            const m = this._last;
    ...
    Y(Q[5], Z([0, 1]), function(U, r) {
      ...
      var E;
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.isAndroid = r.isEdge = r.isSafari = r.isFirefox = r.isChrome = r.isLittleEndian = r.OS = r.setTimeout0 = r.language = r.userAgent = r.isIOS = r.isWebWorker = r.isWeb = r.isNative = r.isLinux = r.isMacintosh = r.isWindows = r.globals = void 0);
      const e = "en";
      let N = !1,
        o = !1,
        w = !1,
      ...
      const p =
          typeof ((E = y == null ? void 0 : y.versions) === null || E === void 0
            ? void 0
            : E.electron) == "string",
      ...
      if (typeof navigator == "object" && !s)
        ...
        if (u)
          try {
            ...
            (h = _.locale), (v = b || e), (L = _._translationsConfigFile);
          } catch {}
        c = !0;
      ...
      o ? (i = 1) : N ? (i = 3) : w && (i = 2),
        ...
        (r.isNative = c),
        (r.isWeb = m),
        (r.isWebWorker = m && typeof r.globals.importScripts == "function"),
        (r.isIOS = t),
        (r.userAgent = C),
        (r.language = v),
        (r.setTimeout0 = (() => {
          if (
            ...
            r.globals.addEventListener("message", b => {
              if (b.data && b.data.vscodeScheduleAsyncWork)
                for (let A = 0, P = u.length; A < P; A++) {
                  const D = u[A];
                  if (D.id === b.data.vscodeScheduleAsyncWork) {
            ...
            return b => {
              ...
              u.push({ id: A, callback: b }),
                r.globals.postMessage({ vscodeScheduleAsyncWork: A }, "*");
            };
          }
    ...
    Y(Q[26], Z([0, 1, 25]), function(U, r, E) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.sep = r.extname = r.basename = r.dirname = r.relative = r.resolve = r.normalize = r.posix = r.win32 = void 0);
      const e = 65,
        N = 97,
        o = 90,
        w = 122,
      ...
      (r.win32 = {
        resolve(...s) {
          ...
          for (let f = s.length - 1; f >= -1; f--) {
            let u;
            if (f >= 0) {
              if (((u = s[f]), h(u, "path"), u.length === 0)) continue;
            } else
              i.length === 0
                ? (u = E.cwd())
                : ((u = E.env[`=${i}`] || E.cwd()),
                  (u === void 0 ||
                    (u.slice(0, 2).toLowerCase() !== i.toLowerCase() &&
                      u.charCodeAt(2) === m)) &&
                    (u = `${i}\\`));
            const _ = u.length;
            let b = 0,
            ...
            if (_ === 1) v(D) && ((b = 1), (P = !0));
              ...
              if (((P = !0), v(u.charCodeAt(1)))) {
                ...
                if (k < _ && k !== R) {
                  const I = u.slice(R, k);
                  for (R = k; k < _ && v(u.charCodeAt(k)); ) k++;
                  if (k < _ && k !== R) {
                    for (R = k; k < _ && !v(u.charCodeAt(k)); ) k++;
                    (k === _ || k !== R) &&
                      ((A = `\\\\${I}\\${u.slice(R, k)}`), (b = k));
            ...
            if (l) {
              ...
              ((a = `${u.slice(b)}\\${a}`), (l = P), P && i.length > 0)
            )
              break;
          }
          return (a = y(a, !l, "\\", v)), l ? `${i}\\${a}` : `${i}${a}` || ".";
        },
        normalize(s) {
          h(s, "path");
          const i = s.length;
          ...
          if (v(u))
            if (((f = !0), v(s.charCodeAt(1)))) {
              ...
              if (b < i && b !== A) {
                ...
                if (b < i && b !== A) {
                  for (A = b; b < i && !v(s.charCodeAt(b)); ) b++;
                  if (b === i) return `\\\\${P}\\${s.slice(A)}\\`;
                  b !== A && ((l = `\\\\${P}\\${s.slice(A, b)}`), (a = b));
                }
              }
            } else a = 1;
          else
        ...
        isAbsolute(s) {
          ...
          return (
            v(a) ||
            (i > 2 && C(a) && s.charCodeAt(1) === S && v(s.charCodeAt(2)))
          );
        },
        join(...s) {
        ...
        relative(s, i) {
          ...
          if (R !== D) {
            ...
            if (P > D) {
              if (i.charCodeAt(b + R) === m) return l.slice(b + R + 1);
              if (R === 2) return l.slice(b + R);
            }
            _ > D && (s.charCodeAt(f + R) === m ? (k = R) : R === 2 && (k = 3)),
              k === -1 && (k = 0);
          }
          let I = "";
          for (R = f + k + 1; R <= u; ++R)
        ...
        toNamespacedPath(s) {
          ...
          if (i.charCodeAt(0) === m) {
            if (i.charCodeAt(1) === m) {
              ...
              if (a !== t && a !== g) return `\\\\?\\UNC\\${i.slice(2)}`;
            }
          } else if (
            C(i.charCodeAt(0)) &&
            i.charCodeAt(1) === S &&
        ...
        dirname(s) {
          ...
          if (v(f)) {
            ...
            C(f) &&
              s.charCodeAt(1) === S &&
              ((a = i > 2 && v(s.charCodeAt(2)) ? 3 : 2), (l = a));
          let u = -1,
            _ = !0;
          for (let b = i - 1; b >= l; --b)
            if (v(s.charCodeAt(b))) {
        ...
        basename(s, i) {
          ...
          if (
            ...
            return (
              a === l ? (l = b) : l === -1 && (l = s.length), s.slice(a, l)
            );
          }
          for (u = s.length - 1; u >= a; --u)
            if (v(s.charCodeAt(u))) {
        ...
        parse(s) {
          ...
          return (
            b !== -1 &&
              (u === -1 || D === 0 || (D === 1 && u === b - 1 && u === _ + 1)
                ? (i.base = i.name = s.slice(_, b))
                : ((i.name = s.slice(_, u)),
                  (i.base = s.slice(_, b)),
                  (i.ext = s.slice(u, b)))),
            _ > 0 && _ !== l ? (i.dir = s.slice(0, _ - 1)) : (i.dir = i.root),
            i
          );
        },
        sep: "\\",
        ...
        (r.posix = {
          resolve(...s) {
            ...
            for (let l = s.length - 1; l >= -1 && !a; l--) {
              ...
              h(f, "path"),
                f.length !== 0 &&
                  ((i = `${f}/${i}`), (a = f.charCodeAt(0) === c));
            }
            return (i = y(i, !a, "/", L)), a ? `/${i}` : i.length > 0 ? i : ".";
          },
          normalize(s) {
          ...
          isAbsolute(s) {
            return h(s, "path"), s.length > 0 && s.charCodeAt(0) === c;
          },
          join(...s) {
            if (s.length === 0) return ".";
            let i;
          ...
          relative(s, i) {
            if (
              ...
              h(i, "to"),
              s === i ||
                ((s = r.posix.resolve(s)), (i = r.posix.resolve(i)), s === i))
            )
              return "";
            const a = 1,
              l = s.length,
            ...
            if (P === b)
              if (_ > b) {
                if (i.charCodeAt(u + P) === c) return i.slice(u + P + 1);
                if (P === 0) return i.slice(u + P);
              } else
                f > b &&
                  (s.charCodeAt(a + P) === c ? (A = P) : P === 0 && (A = 0));
            let D = "";
            for (P = a + A + 1; P <= l; ++P)
          ...
          basename(s, i) {
            ...
            let a = 0,
              ...
              f = !0,
              u;
            if (i !== void 0 && i.length > 0 && i.length <= s.length) {
              if (i === s) return "";
              let _ = i.length - 1,
                b = -1;
          ...
          parse(s) {
            ...
            if (_ !== -1) {
              const D = u === 0 && a ? 1 : u;
              f === -1 || P === 0 || (P === 1 && f === _ - 1 && f === u + 1)
                ? (i.base = i.name = s.slice(D, _))
                : ((i.name = s.slice(D, f)),
                  (i.base = s.slice(D, _)),
                  (i.ext = s.slice(f, _)));
            }
            return u > 0 ? (i.dir = s.slice(0, u - 1)) : a && (i.dir = "/"), i;
          },
          sep: "/",
          delimiter: ":",
          win32: null,
        ...
        (r.normalize =
          E.platform === "win32" ? r.win32.normalize : r.posix.normalize),
        (r.resolve =
          E.platform === "win32" ? r.win32.resolve : r.posix.resolve),
        (r.relative =
          E.platform === "win32" ? r.win32.relative : r.posix.relative),
        (r.dirname =
          E.platform === "win32" ? r.win32.dirname : r.posix.dirname),
        (r.basename =
          E.platform === "win32" ? r.win32.basename : r.posix.basename),
        (r.extname =
    ...
    Y(Q[6], Z([0, 1, 10, 8, 24, 11]), function(U, r, E, e, N, o) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.Relay = r.EventBufferer = r.DebounceEmitter = r.PauseableEmitter = r.Emitter = r.Event = void 0);
      let w = !1,
        g = !1;
      var c;
      (function(s) {
        ...
        function a(X) {
          return (q, G = null, H) => {
            ...
            return (
              (x = X(
                ee => {
                  if (!J) return x ? x.dispose() : (J = !0), q.call(G, ee);
                },
                null,
                H
              )),
        ...
        s.once = a;
        function l(X, q, G) {
          return P((H, J = null, x) => X(ee => H.call(J, q(ee)), null, x), G);
        }
        s.map = l;
        function f(X, q, G) {
          return P(
        ...
        function u(X, q, G) {
          return P(
            (H, J = null, x) => X(ee => q(ee) && H.call(J, ee), null, x),
            G
          );
        }
        s.filter = u;
        ...
        function V(X, q, G = H => H) {
          const H = (...ie) => ee.fire(G(...ie)),
            ...
            ee = new v({ onFirstListenerAdd: J, onLastListenerRemove: x });
          return ee.event;
        }
        ...
        function n(X, q) {
          let G = null;
          function H(x) {
            G == null || G.dispose(), (G = new e.DisposableStore()), q(x, G);
          }
          H(void 0);
          const J = X(x => H(x));
      ...
      class d {
        ...
        static create() {
          var i;
          return new d(
            (i = new Error().stack) !== null && i !== void 0 ? i : ""
          );
        }
        print() {
          console.warn(
...
`)
      ...
      class v {
          ...
          (this._disposed = !1),
            ...
            (this._leakageMon =
              S > 0
                ...
                : void 0),
            (this._perfMon = ((a = this._options) === null || a === void 0
            ? void 0
            : a._profName)
                ...
                queueMicrotask(() => {
                  ...
                  for (const b of u)
                    b.subscription.isset() &&
                      ...
                      (_ = b.stack) === null || _ === void 0 || _.print());
                });
              }
              this._listeners.clear();
            }
            (i = this._deliveryQueue) === null || i === void 0 || i.clear(),
              (l =
        ...
        get event() {
          return (
            this._event ||
              (this._event = (i, a, l) => {
                var f, u, _;
                this._listeners || (this._listeners = new N.LinkedList());
                ...
                this._leakageMon &&
                  ...
                  ((P = d.create()),
                  (A = this._leakageMon.check(P, this._listeners.size + 1))),
                  w && (P = P ?? d.create());
                const D = new h(i, a, P),
                ...
                b &&
                  ...
                  ((_ = this._options) === null || _ === void 0
                    ? void 0
                    : _.onListenerDidAdd) &&
                    this._options.onListenerDidAdd(this, i, a);
        ...
        fire(i) {
          var a, l;
          if (this._listeners) {
            this._deliveryQueue || (this._deliveryQueue = new N.LinkedList());
      ...
      class C extends L {
        constructor(i) {
          var a;
          super(i);
          this._delay = (a = i.delay) !== null && a !== void 0 ? a : 100;
        }
        fire(i) {
          this._handle ||
            (this.pause(),
    ...
    Y(Q[2], Z([0, 1, 17, 23]), function(U, r, E, e) {
      ...
      function d(M, T) {
        ...
        let j = W,
          te = -1;
        for (; (te = M.lastIndexOf(T, j - 1)), !(te === -1 || te + B !== j); ) {
          if (te === 0) return "";
          j = te;
        }
      ...
      const G = /(?:[\u05BE\u05C0\u05C3\u05C6\u05D0-\u05F4\u0608\u060B\u060D\u061B-\u064A\u066D-\u066F\u0671-\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u0710\u0712-\u072F\u074D-\u07A5\u07B1-\u07EA\u07F4\u07F5\u07FA\u07FE-\u0815\u081A\u0824\u0828\u0830-\u0858\u085E-\u088E\u08A0-\u08C9\u200F\uFB1D\uFB1F-\uFB28\uFB2A-\uFD3D\uFD50-\uFDC7\uFDF0-\uFDFC\uFE70-\uFEFC]|\uD802[\uDC00-\uDD1B\uDD20-\uDE00\uDE10-\uDE35\uDE40-\uDEE4\uDEEB-\uDF35\uDF40-\uDFFF]|\uD803[\uDC00-\uDD23\uDE80-\uDEA9\uDEAD-\uDF45\uDF51-\uDF81\uDF86-\uDFF6]|\uD83A[\uDC00-\uDCCF\uDD00-\uDD43\uDD4B-\uDFFF]|\uD83B[\uDC00-\uDEBB])/;
      function H(M) {
        return G.test(M);
      }
      r.containsRTL = H;
      ...
      (r.isBasicASCII = x), (r.UNUSUAL_LINE_TERMINATORS = /[\u2028\u2029]/);
      function ee(M) {
      ...
      function me(M) {
        ...
        return (
          (M = M % (2 * T)),
          M < T ? String.fromCharCode(97 + M) : String.fromCharCode(65 + M - T)
        );
      }
      ...
      function Ce(M, T) {
        return M === 0
          ...
          : M === 2 && T === 3
          ? !1
          : M === 4 || M === 2 || M === 3 || T === 4 || T === 2 || T === 3
          ? !0
          : !(
              (M === 8 && (T === 8 || T === 9 || T === 11 || T === 12)) ||
              ((M === 11 || M === 9) && (T === 9 || T === 10)) ||
              ((M === 12 || M === 10) && T === 10) ||
              T === 5 ||
              T === 13 ||
      ...
      class ge {
        ...
        static getData() {
          return (
            this._data || (this._data = new Set(ge.getRawData())), this._data
          );
        }
    ...
    Y(Q[28], Z([0, 1, 2]), function(U, r, E) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.StringSHA1 = r.toHexString = r.stringHash = r.numberHash = r.doHash = r.hash = void 0);
      function e(L) {
        return N(L, 0);
      }
      r.hash = e;
      ...
      function g(L, C) {
        C = o(149417, C);
        for (let y = 0, p = L.length; y < p; y++) C = o(L.charCodeAt(y), C);
        return C;
      }
      r.stringHash = g;
      function c(L, C) {
      ...
      class v {
        ...
        update(C) {
          ...
          for (
            ...
            if (((s = this._push(p, s, f)), l++, l < y)) a = C.charCodeAt(l);
            else break;
          }
        ...
        digest() {
          return (
            this._finished ||
              ...
              this._wrapUp()),
            h(this._h0) + h(this._h1) + h(this._h2) + h(this._h3) + h(this._h4)
          );
        }
        _wrapUp() {
        ...
        _step() {
          ...
          for (let b = 0; b < 80; b++)
            b < 20
              ...
              : b < 60
              ? ((f = (s & i) | (s & a) | (i & a)), (u = 2400959708))
              : ((f = s ^ i ^ a), (u = 3395469782)),
              (_ = (S(p, 5) + f + l + u + C.getUint32(b * 4, !1)) & 4294967295),
              (l = a),
              (a = i),
              (i = S(s, 30)),
              (s = p),
      ...
      (r.StringSHA1 = v), (v._bigBlock32 = new DataView(new ArrayBuffer(320)));
    }),
    Y(Q[12], Z([0, 1, 19, 28]), function(U, r, E, e) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.LcsDiff = r.MyArray = r.Debug = r.stringDiff = r.StringDiffSequence = void 0);
      class N {
        constructor(t) {
          this.source = t;
        }
        getElements() {
          ...
          for (let h = 0, v = t.length; h < v; h++) d[h] = t.charCodeAt(h);
          return d;
        }
      }
      ...
      class m {
        ...
        _ComputeDiff(t, d, h, v, L) {
          ...
          return (
            L && (y = this.PrettifyChanges(y)), { quitEarly: C[0], changes: y }
          );
        }
        ComputeDiffRecursive(t, d, h, v, L) {
          for (L[0] = !1; t <= d && h <= v && this.ElementsAreEqual(t, h); )
            t++, h++;
          for (; d >= t && v >= h && this.ElementsAreEqual(d, v); ) d--, v--;
          if (t > d || h > v) {
            let a;
            return (
              h <= v
          ...
          if (!L[0]) {
            ...
            return (
              L[0]
                ...
                : (l = this.ComputeDiffRecursive(s + 1, d, i + 1, v, L)),
              this.ConcatenateChanges(a, l)
            );
          }
          return [new E.DiffChange(t, d - t + 1, h, v - h + 1)];
        }
        WALKTRACE(t, d, h, v, L, C, y, p, s, i, a, l, f, u, _, b, A, P) {
          let D = null,
            k = null,
            R = new c(),
            I = d,
          ...
          for (let O = 1; O <= u / 2 + 1; O++) {
            ...
            for (let z = i; z <= a; z += 2) {
              z === i || (z < a && b[z - 1] < b[z + 1])
                ...
                (s = p - (z - P) - k);
              const n = p;
              for (; p < d && s < v && this.ElementsAreEqual(p + 1, s + 1); )
                p++, s++;
              if (
                ((b[z] = p),
                p + s > V + K && ((V = p), (K = s)),
            ...
            if (
              ...
              return (
                ...
                $ > 0 && 1447 > 0 && O <= 1447 + 1
                  ...
                  : (t++, h++, [new E.DiffChange(t, d - t + 1, h, v - h + 1)])
              );
            ...
            for (let z = l; z <= f; z += 2) {
              z === l || (z < f && A[z - 1] >= A[z + 1])
                ...
                (s = p - (z - D) - R);
              const n = p;
              for (; p > t && s > h && this.ElementsAreEqual(p, s); ) p--, s--;
              if (((A[z] = p), F && Math.abs(z - P) <= O && p <= b[z]))
                return (
                  (L[0] = p),
                  (C[0] = s),
        ...
        PrettifyChanges(t) {
          for (let d = 0; d < t.length; d++) {
            ...
            let p = [null];
            if (d < t.length - 1 && this.ChangesOverlap(t[d], t[d + 1], p)) {
          ...
          for (let d = t.length - 1; d >= 0; d--) {
            ...
            for (let a = 1; ; a++) {
              ...
              if (
                ...
                f < L ||
                (C &&
                  !this.OriginalElementsAreEqual(l, l + h.originalLength)) ||
                (y && !this.ModifiedElementsAreEqual(f, f + h.modifiedLength))
              )
                break;
              const _ =
                (l === v && f === L ? 5 : 0) +
                this._boundaryScore(l, h.originalLength, f, h.modifiedLength);
              _ > s && ((s = _), (p = a));
            }
          ...
          if (this._hasStrings)
            for (let d = 1, h = t.length; d < h; d++) {
              const v = t[d - 1],
                L = t[d],
                C = L.originalStart - v.originalStart - v.originalLength,
                y = v.originalStart,
                ...
                l = a - i;
              if (C < 5 && s < 20 && l < 20) {
                const f = this._findBetterContiguousSequence(y, s, i, l, C);
                if (f) {
                  const [u, _] = f;
                  (u !== v.originalStart + v.originalLength ||
                    _ !== v.modifiedStart + v.modifiedLength) &&
                    ((v.originalLength = u - v.originalStart),
                    (v.modifiedLength = _ - v.modifiedStart),
                    (L.originalStart = u + C),
                    (L.modifiedStart = _ + C),
                    (L.originalLength = p - L.originalStart),
                    (L.modifiedLength = a - L.modifiedStart));
                }
              }
            }
          return t;
        ...
        _OriginalRegionIsBoundary(t, d) {
          ...
          if (d > 0) {
            const h = t + d;
            if (this._OriginalIsBoundary(h - 1) || this._OriginalIsBoundary(h))
              return !0;
          }
          return !1;
        }
        ...
        _ModifiedRegionIsBoundary(t, d) {
          ...
          if (d > 0) {
            const h = t + d;
            if (this._ModifiedIsBoundary(h - 1) || this._ModifiedIsBoundary(h))
              return !0;
          }
          return !1;
        }
        ...
        ConcatenateChanges(t, d) {
          let h = [];
          if (t.length === 0 || d.length === 0) return d.length > 0 ? d : t;
        ...
        ChangesOverlap(t, d, h) {
          if (
            ...
            t.originalStart + t.originalLength >= d.originalStart ||
              t.modifiedStart + t.modifiedLength >= d.modifiedStart)
          ) {
            ...
            return (
              t.originalStart + t.originalLength >= d.originalStart &&
                (L = d.originalStart + d.originalLength - t.originalStart),
              t.modifiedStart + t.modifiedLength >= d.modifiedStart &&
                (y = d.modifiedStart + d.modifiedLength - t.modifiedStart),
    ...
    Y(Q[29], Z([0, 1, 7]), function(U, r, E) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.getOrDefault = r.equals = r.mixin = r.cloneAndChange = r.deepFreeze = r.deepClone = void 0);
      function e(t) {
        if (!t || typeof t != "object" || t instanceof RegExp) return t;
        const d = Array.isArray(t) ? [] : {};
        return (
          Object.keys(t).forEach(h => {
            t[h] && typeof t[h] == "object" ? (d[h] = e(t[h])) : (d[h] = t[h]);
          }),
          d
        );
      }
      ...
      function N(t) {
        ...
        for (; d.length > 0; ) {
          ...
          for (const v in h)
            if (o.call(h, v)) {
              const L = h[v];
              typeof L == "object" && !Object.isFrozen(L) && d.push(L);
            }
        }
        return t;
      }
        ...
        return (0, E.isObject)(t)
          ? ((0, E.isObject)(d) &&
              Object.keys(d).forEach(v => {
                v in t
                  ? h &&
                    ((0, E.isObject)(t[v]) && (0, E.isObject)(d[v])
                      ? c(t[v], d[v], h)
                      : (t[v] = d[v]))
                  : (t[v] = d[v]);
              }),
      ...
      function m(t, d) {
        ...
        if (Array.isArray(t)) {
          ...
          for (h = 0; h < t.length; h++) if (!m(t[h], d[h])) return !1;
        } else {
          const L = [];
          for (v in t) L.push(v);
          L.sort();
          ...
          for (h = 0; h < L.length; h++) if (!m(t[L[h]], d[L[h]])) return !1;
        }
        return !0;
      }
      r.equals = m;
    ...
    Y(Q[9], Z([0, 1, 26, 5]), function(U, r, E, e) {
      ...
      class h {
        ...
        with(_) {
          if (!_) return this;
          let { scheme: b, authority: A, path: P, query: D, fragment: k } = _;
          return (
            b === void 0 ? (b = this.scheme) : b === null && (b = S),
            A === void 0 ? (A = this.authority) : A === null && (A = S),
            P === void 0 ? (P = this.path) : P === null && (P = S),
            D === void 0 ? (D = this.query) : D === null && (D = S),
            k === void 0 ? (k = this.fragment) : k === null && (k = S),
            b === this.scheme &&
            A === this.authority &&
            P === this.path &&
            D === this.query &&
        ...
        static file(_) {
          let b = S;
          if (
            (e.isWindows && (_ = _.replace(/\\/g, t)), _[0] === t && _[1] === t)
          ) {
            const A = _.indexOf(t, 2);
            A === -1
              ? ((b = _.substring(2)), (_ = t))
              : ((b = _.substring(2, A)), (_ = _.substring(A) || t));
          }
          return new L("file", b, _, S, S);
        }
        static from(_) {
          const b = new L(_.scheme, _.authority, _.path, _.query, _.fragment);
          return g(b, !0), b;
        }
        static joinPath(_, ...b) {
          if (!_.path)
      ...
      class L extends h {
        ...
        toJSON() {
          const _ = { $mid: 1 };
          return (
            this._fsPath && ((_.fsPath = this._fsPath), (_._sep = v)),
      ...
      function y(u, _) {
        ...
        for (let P = 0; P < u.length; P++) {
          ...
          if (
            ...
            A !== -1 &&
              ((b += encodeURIComponent(u.substring(A, P))), (A = -1)),
        ...
        return (
          u.authority && u.path.length > 1 && u.scheme === "file"
            ...
            : u.path.charCodeAt(0) === 47 &&
              ((u.path.charCodeAt(1) >= 65 && u.path.charCodeAt(1) <= 90) ||
                (u.path.charCodeAt(1) >= 97 && u.path.charCodeAt(1) <= 122)) &&
      ...
      function i(u, _) {
        const b = _ ? p : y;
        let A = "",
          { scheme: P, authority: D, path: k, query: R, fragment: I } = u;
        if (
          (P && ((A += P), (A += ":")),
          (D || P === "file") && ((A += t), (A += t)),
          D)
          ...
          (D = D.toLowerCase()),
            ...
            F === -1
              ? (A += b(D, !1))
              : ((A += b(D.substr(0, F), !1)), (A += D.substr(F)));
        }
        if (k) {
          if (
            k.length >= 3 &&
            ...
            F >= 65 &&
              F <= 90 &&
              (k = `/${String.fromCharCode(F + 32)}:${k.substr(3)}`);
          } else if (k.length >= 2 && k.charCodeAt(1) === 58) {
            const F = k.charCodeAt(0);
            F >= 65 &&
              F <= 90 &&
              (k = `${String.fromCharCode(F + 32)}:${k.substr(2)}`);
          }
          A += b(k, !0);
        }
        return (
    ...
    Y(Q[44], Z([0, 1, 10, 6, 8, 5, 7, 2]), function(U, r, E, e, N, o, w, g) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.create = r.SimpleWorkerServer = r.SimpleWorkerClient = r.logOnceWebWorkerWarning = void 0);
      const c = "$initialize";
      let m = !1;
      function S(f) {
        !o.isWeb ||
      ...
      class C {
        ...
        sendMessage(u, _) {
          ...
          return new Promise((A, P) => {
            (this._pendingReplies[b] = { resolve: A, reject: P }),
        ...
        handleMessage(u) {
          !u ||
            !u.vsWorker ||
            (this._workerId !== -1 && u.vsWorker !== this._workerId) ||
          ...
          this._handler.handleMessage(u.method, u.args).then(
            ...
            A => {
              A.detail instanceof Error &&
                (A.detail = (0, E.transformErrorForSerialization)(A.detail)),
                this._send(
                  new d(
                    this._workerId,
                    _,
                    void 0,
                    (0, E.transformErrorForSerialization)(A)
                  )
                );
            }
          );
        ...
        _send(u) {
          ...
          if (u.type === 0)
            for (let b = 0; b < u.args.length; b++)
              u.args[b] instanceof ArrayBuffer && _.push(u.args[b]);
          else u.type === 1 && u.res instanceof ArrayBuffer && _.push(u.res);
          ...
          (this._worker = this._register(
            ...
            (this._protocol = new C({
              ...
              handleMessage: (I, F) => {
                ...
                try {
                  return Promise.resolve(b[I].apply(b, F));
                } catch (O) {
          ...
          this._lazyProxy = new Promise((I, F) => {
            (A = F),
              this._onModuleLoaded.then(
                ...
                O => {
                  F(O), this._onError("Worker failed to load " + _, O);
                }
              );
          });
        }
      ...
      function p(f) {
        return (
          f[0] === "o" && f[1] === "n" && g.isUpperAsciiLetter(f.charCodeAt(2))
        );
      }
      function s(f) {
        return /^onDynamic/.test(f) && g.isUpperAsciiLetter(f.charCodeAt(9));
      }
      function i(f, u, _) {
        const b = D =>
            function() {
              const k = Array.prototype.slice.call(arguments, 0);
              return u(D, k);
            },
          A = D =>
            function(k) {
      ...
      class a {
        constructor(u, _) {
          (this._requestHandlerFactory = _),
            ...
            (this._protocol = new C({
              ...
              handleMessage: (b, A) => this._handleMessage(b, A),
        ...
        _handleMessage(u, _) {
          if (u === c) return this.initialize(_[0], _[1], _[2], _[3]);
          if (
            !this._requestHandler ||
            typeof this._requestHandler[u] != "function"
          )
            return Promise.reject(
              new Error("Missing requestHandler or method: " + u)
            );
          try {
            return Promise.resolve(
              this._requestHandler[u].apply(this._requestHandler, _)
            );
          } catch (b) {
        ...
        _handleEvent(u, _) {
          ...
          if (s(u)) {
            const b = this._requestHandler[u].call(this._requestHandler, _);
            if (typeof b != "function")
              throw new Error(`Missing dynamic event ${u} on request handler.`);
            return b;
          }
          if (p(u)) {
            const b = this._requestHandler[u];
            if (typeof b != "function")
              throw new Error(`Missing event ${u} on request handler.`);
            return b;
          }
        ...
        initialize(u, _, b, A) {
          ...
          return this._requestHandlerFactory
            ? ((this._requestHandler = this._requestHandlerFactory(k)),
              Promise.resolve(w.getAllMethodNames(this._requestHandler)))
            : (_ &&
              ...
              new Promise((R, I) => {
                (o.globals.require || U)(
                  ...
                  O => {
                    if (
                      ((this._requestHandler = O.create(k)),
                      !this._requestHandler)
                    ) {
                      I(new Error("No RequestHandler!"));
                      return;
                    }
                    R(w.getAllMethodNames(this._requestHandler));
                  },
                  I
                );
              }));
    ...
    Y(Q[14], Z([0, 1, 13]), function(U, r, E) {
      ...
      class e {
        ...
        set(w, g) {
          ...
          w >= 0 && w < 256 ? (this._asciiMap[w] = c) : this._map.set(w, c);
        }
        get(w) {
          return w >= 0 && w < 256
            ? this._asciiMap[w]
      ...
      class e {
        ...
        static containsPosition(o, w) {
          return !(
            ...
            (w.lineNumber === o.startLineNumber && w.column < o.startColumn) ||
            (w.lineNumber === o.endLineNumber && w.column > o.endColumn)
          );
        }
        ...
        static containsRange(o, w) {
          return !(
            ...
            (w.endLineNumber === o.endLineNumber && w.endColumn > o.endColumn)
          );
        }
        ...
        static intersectRanges(o, w) {
          let g = o.startLineNumber,
            ...
            v = w.endColumn;
          return (
            g < t ? ((g = t), (c = d)) : g === t && (c = Math.max(c, d)),
            m > h ? ((m = h), (S = v)) : m === h && (S = Math.min(S, v)),
        ...
        static fromPositions(o, w = o) {
          return new e(o.lineNumber, o.column, w.lineNumber, w.column);
        }
        static lift(o) {
          return o
            ? new e(
    ...
    Y(Q[30], Z([0, 1, 3, 4]), function(U, r, E, e) {
      ...
      class N extends e.Range {
        ...
        static selectionsEqual(w, g) {
          return (
            w.selectionStartLineNumber === g.selectionStartLineNumber &&
        ...
        static fromPositions(w, g = w) {
          return new N(w.lineNumber, w.column, g.lineNumber, g.column);
        }
    ...
    Y(Q[15], Z([0, 1]), function(U, r) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.getWordAtText = r.ensureValidWordDefinition = r.DEFAULT_WORD_REGEXP = r.USUAL_WORD_SEPARATORS = void 0),
    ...
    Y(Q[32], Z([0, 1, 12, 2]), function(U, r, E, e) {
      ...
      class w {
        constructor(C) {
          ...
          (this.lines = C), (this._startColumns = y), (this._endColumns = p);
        }
        getElements() {
          const C = [];
        ...
        createCharSequence(C, y, p) {
          ...
          for (let f = y; f <= p; f++) {
            ...
            for (let A = _; A < b; A++)
              (s[l] = u.charCodeAt(A - 1)), (i[l] = f + 1), (a[l] = A), l++;
          }
          return new g(s, i, a);
        }
      }
      class g {
        constructor(C, y, p) {
          (this._charCodes = C), (this._lineNumbers = y), (this._columns = p);
        }
        getElements() {
          ...
          return (
            C.originalLength === 0
              ...
              : ((s = y.getStartLineNumber(C.originalStart)),
                ...
                (l = y.getEndColumn(C.originalStart + C.originalLength - 1))),
            C.modifiedLength === 0
              ? ((f = 0), (u = 0), (_ = 0), (b = 0))
              : ((f = p.getStartLineNumber(C.modifiedStart)),
                ...
                (b = p.getEndColumn(C.modifiedStart + C.modifiedLength - 1))),
      ...
      function m(L) {
        ...
        for (let p = 1, s = L.length; p < s; p++) {
          const i = L[p],
            a = i.originalStart - (y.originalStart + y.originalLength),
            l = i.modifiedStart - (y.modifiedStart + y.modifiedLength);
          Math.min(a, l) < N
            ? ((y.originalLength =
                i.originalStart + i.originalLength - y.originalStart),
              (y.modifiedLength =
                i.modifiedStart + i.modifiedLength - y.modifiedStart))
            : (C.push(i), (y = i));
        }
        return C;
      }
      ...
      class t {
        ...
        _pushTrimWhitespaceCharChange(C, y, p, s, i, a, l) {
          if (this._mergeTrimWhitespaceCharChange(C, y, p, s, i, a, l)) return;
          let f;
          this.shouldComputeCharChanges &&
    ...
    Y(Q[33], Z([0, 1, 14]), function(U, r, E) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.computeLinks = r.LinkComputer = r.StateMachine = r.Uint8Matrix = void 0);
      class e {
        constructor(d, h, v) {
      ...
      class N {
        ...
        nextState(d, h) {
          return h < 0 || h >= this._maxCharCode ? 0 : this._states.get(d, h);
        }
      }
      r.StateMachine = N;
      let o = null;
      ...
      function c() {
        if (g === null) {
          ...
          const t = ` 	<>'"\u3001\u3002\uFF61\uFF64\uFF0C\uFF0E\uFF1A\uFF1B\u2018\u3008\u300C\u300E\u3014\uFF08\uFF3B\uFF5B\uFF62\uFF63\uFF5D\uFF3D\uFF09\u3015\u300F\u300D\u3009\u2019\uFF40\uFF5E\u2026`;
          for (let h = 0; h < t.length; h++) g.set(t.charCodeAt(h), 1);
          const d = ".,;";
          for (let h = 0; h < d.length; h++) g.set(d.charCodeAt(h), 2);
        }
        return g;
      }
      class m {
          ...
          for (let C = 1, y = d.getLineCount(); C <= y; C++) {
            ...
            for (; i < s; ) {
              ...
              if (f === 13) {
                ...
                k === 1 && (L.push(m._createLink(v, p, C, a, i)), (P = !0));
              } else if (f === 12) {
                let k;
      ...
      class E {
        ...
        numberReplace(N, o) {
          ...
          return !isNaN(g) && !isNaN(c) && g === c
            ? g === 0 && !o
              ? null
              : ((g = Math.floor(g * w)), (g += o ? w : -w), String(g / w))
            : null;
        }
        textReplace(N, o) {
    ...
    Y(Q[35], Z([0, 1, 29]), function(U, r, E) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.shouldSynchronizeModel = r.ApplyEditsResult = r.SearchData = r.ValidAnnotatedEditOperation = r.FindMatch = r.TextModelResolvedOptions = r.InjectedTextCursorStops = r.MinimapPosition = r.OverviewRulerLane = void 0);
      var e;
      (function(d) {
        (d[(d.Left = 1)] = "Left"),
          (d[(d.Center = 2)] = "Center"),
      ...
      (function(d) {
        (d[(d.Both = 0)] = "Both"),
          ...
          (d[(d.Left = 2)] = "Left"),
          (d[(d.None = 3)] = "None");
      })((o = r.InjectedTextCursorStops || (r.InjectedTextCursorStops = {})));
      class w {
        constructor(h) {
          (this._textModelResolvedOptionsBrand = void 0),
            ...
            (this.trimAutoWhitespace = Boolean(h.trimAutoWhitespace)),
        ...
        createChangeEvent(h) {
          return {
            ...
            trimAutoWhitespace: this.trimAutoWhitespace !== h.trimAutoWhitespace
          };
        }
      }
      ...
      class g {
        constructor(h, v) {
          (this._findMatchBrand = void 0), (this.range = h), (this.matches = v);
        }
      }
      r.FindMatch = g;
      class c {
      ...
      class m {
        constructor(h, v, L) {
          (this.regex = h), (this.wordSeparators = v), (this.simpleSearch = L);
        }
      }
      r.SearchData = m;
      class S {
    ...
    Y(Q[36], Z([0, 1, 16, 13]), function(U, r, E, e) {
      ...
      class o {
        ...
        _ensureValid() {
          if (!this._isValid) {
            for (
              let c = this._validEndIndex + 1, m = this._values.length;
              c < m;
              c++
            ) {
              ...
              for (let d = 0; d < S; d++) this._indexBySum[t + d] = c;
            }
            (this._prefixSum.length = this._values.length),
              (this._indexBySum.length = this._prefixSum[
                this._prefixSum.length - 1
              ]),
              (this._isValid = !0),
        ...
        setValue(c, m) {
          this._values[c] !== m && ((this._values[c] = m), this._invalidate(c));
        }
      }
      ...
      class o {
          ...
          for (const m of c)
            this._acceptDeleteRange(m.range),
              this._acceptInsertText(
                new e.Position(m.range.startLineNumber, m.range.startColumn),
                m.text
              );
          (this._versionId = g.versionId), (this._cachedTextValue = null);
        }
        _ensureLineStarts() {
          if (!this._lineStarts) {
            const g = this._eol.length,
              ...
              m = new Uint32Array(c);
            for (let S = 0; S < c; S++) m[S] = this._lines[S].length + g;
          ...
          if (g.startLineNumber === g.endLineNumber) {
            ...
            this._setLineText(
              ...
              this._lines[g.startLineNumber - 1].substring(
                0,
                g.startColumn - 1
              ) + this._lines[g.startLineNumber - 1].substring(g.endColumn - 1)
            );
            return;
          }
          this._setLineText(
            g.startLineNumber - 1,
            this._lines[g.startLineNumber - 1].substring(0, g.startColumn - 1) +
              this._lines[g.endLineNumber - 1].substring(g.endColumn - 1)
          ),
            this._lines.splice(
              g.startLineNumber,
        ...
        _acceptInsertText(g, c) {
          ...
          if (m.length === 1) {
            this._setLineText(
              g.lineNumber - 1,
              this._lines[g.lineNumber - 1].substring(0, g.column - 1) +
                m[0] +
                this._lines[g.lineNumber - 1].substring(g.column - 1)
            );
            return;
          }
          (m[m.length - 1] += this._lines[g.lineNumber - 1].substring(
            ...
            this._setLineText(
              g.lineNumber - 1,
              this._lines[g.lineNumber - 1].substring(0, g.column - 1) + m[0]
            );
          ...
          this._lineStarts && this._lineStarts.insertValues(g.lineNumber, S);
        }
      }
      r.MirrorTextModel = o;
    }),
    Y(Q[38], Z([0, 1, 2, 31, 3, 4, 35]), function(U, r, E, e, N, o, w) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.Searcher = r.isValidMatch = r.TextModelSearch = r.createFindMatch = r.isMultilineRegexSource = r.SearchParams = void 0);
      const g = 999;
      class c {
        constructor(p, s, i, a) {
          (this.searchString = p),
      ...
      class d {
        ...
        static _getMultilineMatchRange(p, s, i, a, l, f) {
          let u,
            _ = 0;
          a
            ? ((_ = a.findLineFeedCountBeforeOffset(l)), (u = s + l + _))
            : (u = s + l);
          let b;
          if (a) {
            const k = a.findLineFeedCountBeforeOffset(l + f.length) - _;
            b = u + f.length + k;
          } else b = u + f.length;
          const A = p.getPositionAt(u),
            P = p.getPositionAt(b);
          return new o.Range(A.lineNumber, A.column, P.lineNumber, P.column);
        }
...
`
          ...
          for (i.reset(0); (P = i.next(u)); )
            if (
              ((b[A++] = S(
                this._getMultilineMatchRange(p, f, u, _, P.index, P[0]),
                P,
                a
              )),
              A >= l)
        ...
        static _doFindMatchesLineByLine(p, s, i, a, l) {
          ...
          for (let b = s.startLineNumber + 1; b < s.endLineNumber && u < l; b++)
            u = this._findMatchesInLine(
              i,
              p.getLineContent(b),
              b,
          ...
          if (u < l) {
            ...
            u = this._findMatchesInLine(i, b, s.endLineNumber, 0, u, f, a, l);
          }
          return f;
        }
        ...
        static _doFindNextMatchMultiline(p, s, i, a) {
          const l = new N.Position(s.lineNumber, 1),
            ...
            u = p.getLineCount(),
            _ = p.getValueInRange(
              new o.Range(l.lineNumber, l.column, u, p.getLineMaxColumn(u)),
              1
            ),
            b =
              p.getEOL() ===
...
`
          ...
          let A = i.next(_);
          return A
            ? S(this._getMultilineMatchRange(p, f, _, b, A.index, A[0]), A, a)
            : s.lineNumber !== 1 || s.column !== 1
            ? this._doFindNextMatchMultiline(p, new N.Position(1, 1), i, a)
            : null;
        }
        ...
        static _findFirstMatchInLine(p, s, i, a, l) {
          ...
          const f = p.next(s);
          return f
            ? S(new o.Range(i, f.index + 1, i, f.index + 1 + f[0].length), f, l)
            : null;
        }
        ...
        static _doFindPreviousMatchMultiline(p, s, i, a) {
          ...
          return s.lineNumber !== f || s.column !== p.getLineMaxColumn(f)
        ...
        static _findLastMatchInLine(p, s, i, a) {
          ...
          for (p.reset(0); (f = p.next(s)); )
            l = S(
              new o.Range(i, f.index + 1, i, f.index + 1 + f[0].length),
              f,
              a
            );
          return l;
        ...
        next(p) {
          ...
          do {
            ...
            if (
              ...
              if (l === 0) {
                E.getNextCodePoint(p, s, this._searchRegex.lastIndex) > 65535
            ...
            if (
              ...
              !this._wordSeparators || L(this._wordSeparators, p, s, a, l))
            )
              return i;
          } while (i);
          return null;
            ...
            do
              if (((f = i.next(D)), f)) {
                ...
                const F = D.substring(R, I),
                  O = (0, w.getWordAtText)(R + 1, w.DEFAULT_WORD_REGEXP, D, 0),
                  V = y.shouldHighlightNonBasicASCII(F, O ? O.word : null);
                if (V !== 0) {
                  V === 3
                    ? u++
                    : V === 2
          ...
          switch (v.shouldHighlightNonBasicASCII(d, null)) {
            ...
            case 3: {
              const C = d.codePointAt(0),
                y = v.ambiguousCharacters.getPrimaryConfusable(C),
      ...
      class m {
        constructor(d) {
          (this.options = d),
            ...
            (this.ambiguousCharacters = N.AmbiguousCharacters.getInstance(
            ...
            for (let y of h) {
              ...
              (L = L || s),
                !s &&
                  ...
                  !N.InvisibleCharacters.isInvisibleCharacter(p) &&
                  (C = !0);
            }
          return !L && C
            ? 0
...
` ||
    ...
    Y(Q[40], Z([0, 1]), function(U, r) {
      ...
      (function(n) {
        (n[(n.None = 0)] = "None"),
          ...
          (n[(n.Full = 4)] = "Full");
      })((t = r.EditorAutoIndentStrategy || (r.EditorAutoIndentStrategy = {})));
      var d;
      (function(n) {
        (n[(n.acceptSuggestionOnCommitCharacter = 0)] =
          ...
          (n[(n.emptySelectionClipboard = 32)] = "emptySelectionClipboard"),
          (n[(n.extraEditorClassName = 33)] = "extraEditorClassName"),
          (n[(n.fastScrollSensitivity = 34)] = "fastScrollSensitivity"),
          (n[(n.find = 35)] = "find"),
          ...
          (n[(n.foldingImportsByDefault = 40)] = "foldingImportsByDefault"),
          (n[(n.foldingMaximumRegions = 41)] = "foldingMaximumRegions"),
          ...
          (n[(n.hideCursorInOverviewRuler = 52)] = "hideCursorInOverviewRuler"),
          (n[(n.hover = 53)] = "hover"),
          ...
          (n[(n.peekWidgetDefaultFocus = 77)] = "peekWidgetDefaultFocus"),
          (n[(n.definitionLinkOpensInPeek = 78)] = "definitionLinkOpensInPeek"),
          (n[(n.quickSuggestions = 79)] = "quickSuggestions"),
          (n[(n.quickSuggestionsDelay = 80)] = "quickSuggestionsDelay"),
          (n[(n.readOnly = 81)] = "readOnly"),
          (n[(n.renameOnType = 82)] = "renameOnType"),
          (n[(n.renderControlCharacters = 83)] = "renderControlCharacters"),
          ...
          (n[(n.scrollBeyondLastColumn = 93)] = "scrollBeyondLastColumn"),
          (n[(n.scrollBeyondLastLine = 94)] = "scrollBeyondLastLine"),
          (n[(n.scrollPredominantAxis = 95)] = "scrollPredominantAxis"),
          ...
          (n[(n.stopRenderingLineAfter = 105)] = "stopRenderingLineAfter"),
          ...
          (n[(n.unusualLineTerminators = 114)] = "unusualLineTerminators"),
      ...
      (function(n) {
        (n[(n.Both = 0)] = "Both"),
          ...
          (n[(n.Left = 2)] = "Left"),
          (n[(n.None = 3)] = "None");
      })((C = r.InjectedTextCursorStops || (r.InjectedTextCursorStops = {})));
      var y;
      (function(n) {
      ...
      })((I = r.SignatureHelpTriggerKind || (r.SignatureHelpTriggerKind = {})));
      var F;
      (function(n) {
        (n[(n.File = 0)] = "File"),
          (n[(n.Module = 1)] = "Module"),
  ...
  Y(Q[41], Z([0, 1, 6, 8]), function(U, r, E, e) {
    ...
    class N {
      ...
      fire(g) {
        this._onDidChange.fire({ changedLanguages: g, changedColorMap: !1 });
      }
      register(g, c) {
        return (
          this._map.set(g, c),
          this.fire([g]),
          (0, e.toDisposable)(() => {
            this._map.get(g) === c && (this._map.delete(g), this.fire([g]));
          })
        );
      }
      registerFactory(g, c) {
        var m;
        (m = this._factories.get(g)) === null || m === void 0 || m.dispose();
        const S = new o(this, g, c);
        return (
          this._factories.set(g, S),
          (0, e.toDisposable)(() => {
            const t = this._factories.get(g);
            !t || t !== S || (this._factories.delete(g), t.dispose());
          })
        );
      }
      getOrCreate(g) {
        return oe(this, void 0, void 0, function*() {
          ...
          return !m || m.isResolved ? null : (yield m.resolve(), this.get(g));
        });
      }
      get(g) {
      ...
      _create() {
        return oe(this, void 0, void 0, function*() {
          ...
          (this._isResolved = !0),
            g &&
              !this._isDisposed &&
              this._register(this._registry.register(this._languageId, g));
        });
      }
    }
  }),
    Y(Q[42], Z([0, 1, 9, 4, 41, 18]), function(U, r, E, e, N, o) {
      "use strict";
      Object.defineProperty(r, "__esModule", { value: !0 }),
        (r.TokenizationRegistry = r.InlayHintKind = r.Command = r.FoldingRangeKind = r.SymbolKinds = r.isLocationLink = r.DocumentHighlightKind = r.SignatureHelpTriggerKind = r.InlineCompletionTriggerKind = r.CompletionItemKinds = r.EncodedTokenizationResult = r.TokenizationResult = r.Token = r.TokenMetadata = void 0);
      class w {
      ...
      (function(s) {
        ...
        function a(u) {
          ...
          return (
            _ ||
              (console.info("No codicon found for CompletionItemKind " + u),
      ...
      })((d = r.SignatureHelpTriggerKind || (r.SignatureHelpTriggerKind = {})));
      var h;
      (function(s) {
        (s[(s.Text = 0)] = "Text"),
          (s[(s.Read = 1)] = "Read"),
    ...
    Y(Q[43], Z([0, 1, 27, 6, 22, 9, 3, 4, 30, 42, 40]), function(
      U,
      r,
      E,
      e,
      ...
      function(U, r, E, e, N, o, w, g, c, m, S, t, d, h, v, L) {
        ...
        class C extends c.MirrorTextModel {
          ...
          words(i) {
            ...
            return {
              *[Symbol.iterator]() {
                for (;;)
                  if (_ < b.length) {
                    const A = u.substring(b[_].start, b[_].end);
                    (_ += 1), yield A;
                  } else if (f < a.length)
                    (u = a[f]), (b = l(u, i)), (_ = 0), (f += 1);
                  else break;
              }
            };
          }
          ...
          _wordenize(i, a) {
            const l = [];
            let f;
            for (a.lastIndex = 0; (f = a.exec(i)) && f[0].length !== 0; )
              l.push({ start: f.index, end: f.index + f[0].length });
            return l;
          }
          getValueInRange(i) {
            if (
            ...
            return (
              u.push(this._lines[f].substring(0, i.endColumn - 1)), u.join(a)
            );
          }
          offsetAt(i) {
            return (
          ...
          _validatePosition(i) {
            if (!o.Position.isIPosition(i)) throw new Error("bad position");
        ...
        class y {
          ...
          _getModels() {
            const i = [];
            return (
              Object.keys(this._models).forEach(a => i.push(this._models[a])), i
            );
          }
          acceptNewModel(i) {
          ...
          computeDiff(i, a, l, f) {
            return oe(this, void 0, void 0, function*() {
              ...
              const b = u.getLinesContent(),
                ...
                k = D.changes.length > 0 ? !1 : this._modelsAreIdentical(u, _);
              return {
          ...
          computeMoreMinimalEdits(i, a) {
            return oe(this, void 0, void 0, function*() {
              ...
              a = a.slice(0).sort((_, b) => {
                if (_.range && b.range)
                  return w.Range.compareRangesUsingStarts(_.range, b.range);
                const A = _.range ? 0 : 1,
                  P = b.range ? 0 : 1;
                return A - P;
              });
              for (let { range: _, text: b, eol: A } of a) {
                if ((typeof A == "number" && (u = A), w.Range.isEmpty(_) && !b))
                  continue;
                const P = l.getValueInRange(_);
                if (((b = b.replace(/\r\n|\n|\r/g, l.eol)), P === b)) continue;
                if (Math.max(b.length, P.length) > y._diffLimit) {
                  f.push({ range: _, text: b });
                  continue;
                }
                const D = (0, E.stringDiff)(P, b, !1),
                  k = l.offsetAt(w.Range.lift(_).getStartPosition());
                for (const R of D) {
                  const I = l.positionAt(k + R.originalStart),
                    F = l.positionAt(k + R.originalStart + R.originalLength),
                    O = {
                      text: b.substr(R.modifiedStart, R.modifiedLength),
                      range: {
                  ...
                  l.getValueInRange(O.range) !== O.text && f.push(O);
                }
              }
              return (
                typeof u == "number" &&
              ...
              e: for (let A of i) {
                ...
                if (!!P) {
                  for (let D of P.words(_))
                    if (
                      !(D === a || !isNaN(Number(D))) &&
                      (b.add(D), b.size > y._suggestionsLimit)
                    )
                      break e;
                }
              }
              return { words: Array.from(b), duration: u.elapsed() };
            });
          }
          computeWordRanges(i, a, l, f) {
            return oe(this, void 0, void 0, function*() {
              ...
              for (let A = a.startLineNumber; A < a.endLineNumber; A++) {
          ...
          loadForeignModule(i, a, l) {
            ...
            return this._foreignModuleFactory
              ? ((this._foreignModule = this._foreignModuleFactory(_, a)),
                Promise.resolve(h.getAllMethodNames(this._foreignModule)))
              : new Promise((b, A) => {
                  U(
                    [i],
                    P => {
                      (this._foreignModule = P.create(_, a)),
                        b(h.getAllMethodNames(this._foreignModule));
                    },
                    A
                  );
                });
          ...
          fmr(i, a) {
            ...
            try {
              return Promise.resolve(
                this._foreignModule[i].apply(this._foreignModule, a)
              );
            } catch (l) {
...
${h}
      ...
      function w() {
        return new Promise((S, t) => {
          if (typeof self.define == "function" && self.define.amd) return S();
          ...
          if (
            ...
            fetch(d)
              ...
              .then(v => {
                (v = `${v}
//# sourceURL=${d}`),
                  (N ? self.eval(N.createScript("", v)) : new Function(v)).call(
                    self
                  ),
                  S();
              })
          ...
          N ? importScripts(N.createScriptURL(d)) : importScripts(d), S();
        });
      }
      const g = function(S) {
        w().then(() => {
          require.config({
            ...
            require([S], function(t) {
              setTimeout(function() {
                ...
                for (
                  self.onmessage = h => d.onmessage(h.data, h.ports);
                  m.length > 0;
