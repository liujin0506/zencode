 ...
 *-----------------------------------------------------------*/ define("vs/editor/editor.main.nls.it", {
  ...
  "vs/base/parts/quickinput/browser/quickInputList": ["Input rapido"],
  "vs/editor/browser/controller/textAreaHandler": [
    "editor",
    "L'editor non \xE8 accessibile in questo momento. Premere {0} per le opzioni."
  ],
  ...
  "vs/editor/browser/widget/codeEditorWidget": [
    "Il numero di cursori \xE8 stato limitato a {0}."
  ],
  "vs/editor/browser/widget/diffEditorWidget": [
    "Effetto di riga per gli inserimenti nell'editor diff.",
    "Effetto di riga per le rimozioni nell'editor diff.",
    "Non \xE8 possibile confrontare i file perch\xE9 uno \xE8 troppo grande."
  ],
  ...
  "vs/editor/common/config/editorConfigurationSchema": [
    "Editor",
    "Numero di spazi a cui equivale una tabulazione. Quando `#editor.detectIndentation#` \xE8 attivo, questa impostazione viene sostituita in base al contenuto del file.",
    "Inserisce spazi quando viene premuto TAB. Quando `#editor.detectIndentation#` \xE8 attivo, questa impostazione viene sostituita in base al contenuto del file.",
  ...
  "vs/editor/common/config/editorOptions": [
    "L'editor user\xE0 le API della piattaforma per rilevare quando viene collegata un'utilit\xE0 per la lettura dello schermo.",
    "L'editor verr\xE0 definitivamente ottimizzato per l'utilizzo con un'utilit\xE0 per la lettura dello schermo. Il ritorno a capo automatico verr\xE0 disabilitato.",
    "L'editor non verr\xE0 mai ottimizzato per l'utilizzo con un'utilit\xE0 per la lettura dello schermo.",
    "Controlla se l'editor deve essere eseguito in una modalit\xE0 ottimizzata per le utilit\xE0 per la lettura dello schermo. Se viene attivata, il ritorno a capo automatico verr\xE0 disabilitato.",
    ...
    "Controlla le dimensioni del carattere dei suggerimenti incorporati nell'editor. Viene usato il valore predefinito 90% di `#editor.fontSize#` quando il valore configurato \xE8 minore di `5` o maggiore delle dimensioni del carattere dell'editor.",
 ...
 - I valori maggiori o uguali a 8 verranno usati come valori effettivi.`,
    ...
    "Controlla se la colorazione delle coppie di parentesi \xE8 abilitata. Usare 'workbench.colorCustomizations' per eseguire l'override dei colori di evidenziazione delle parentesi.",
    ...
    "Altezza della riga per il widget dei suggerimenti. Se impostato su `0`, viene usato il valore `editor.lineHeight#`. Il valore minimo \xE8 8.",
  ...
  "vs/editor/common/core/editorColorRegistry": [
    ...
    "Colore di sfondo del righello delle annotazioni dell'editor. Viene usato solo quando la minimappa \xE8 abilitata e posizionata sul lato destro dell'editor.",
  ...
  "vs/editor/common/standaloneStrings": [
    ...
    "Apertura della pagina di documentazione sull'accessibilit\xE0 dell'editor.",
    ...
    "Per configurare l'editor da ottimizzare per l'utilizzo con un'utilit\xE0 per la lettura dello schermo, premere Comando+E.",
    "Per configurare l'editor da ottimizzare per l'utilizzo con un'utilit\xE0 per la lettura dello schermo, premere CTRL+E.",
    "L'editor \xE8 configurato per essere ottimizzato per l'utilizzo con un'utilit\xE0 per la lettura dello schermo.",
    "L'editor \xE8 configurato per non essere ottimizzato per l'utilizzo con un'utilit\xE0 per la lettura dello schermo, che non viene usata in questo momento.",
    ...
    "Premere TAB nell'editor corrente per spostare lo stato attivo sull'elemento con stato attivabile successivo. Il comando {0} non pu\xF2 essere attualmente attivato con un tasto di scelta rapida.",
    ...
    "Premere TAB nell'editor corrente per inserire il carattere di tabulazione. Il comando {0} non pu\xF2 essere attualmente attivato con un tasto di scelta rapida.",
    "Premere Comando+H per aprire una finestra del browser contenente maggiori informazioni correlate all'accessibilit\xE0 dell'editor.",
    "Premere CTRL+H per aprire una finestra del browser contenente maggiori informazioni correlate all'accessibilit\xE0 dell'editor.",
    "Per chiudere questa descrizione comando e tornare all'editor, premere ESC o MAIUSC+ESC.",
    "Visualizza la Guida sull'accessibilit\xE0",
  ...
  "vs/editor/contrib/find/browser/findController": [
    "Trova",
    "&&Trova",
    `Esegue l'override del contrassegno "Usa espressione regolare".\r
Il contrassegno non verr\xE0 salvato per il futuro.\r
0: Non eseguire alcuna operazione\r
1: Vero\r
2: Falso`,
    `Esegue l'override del contrassegno "Corrispondenza parola intera".\r
Il contrassegno non verr\xE0 salvato per il futuro.\r
0: Non eseguire alcuna operazione\r
1: Vero\r
2: Falso`,
    `Esegue l'override del contrassegno "Fai corrispondere maiuscole/minuscole".\r
Il contrassegno non verr\xE0 salvato per il futuro.\r
0: Non eseguire alcuna operazione\r
1: Vero\r
2: Falso`,
    `Esegue l'override del contrassegno "Mantieni maiuscole/minuscole".\r
Il contrassegno non verr\xE0 salvato per il futuro.\r
0: Non eseguire alcuna operazione\r
1: Vero\r
2: Falso`,
  ...
  "vs/editor/contrib/folding/browser/folding": [
    `Il numero di aree riducibili \xE8 limitato a un massimo di {0}. Aumentare l'opzione di configurazione ['Numero massimo di aree riducibili'](command:workbench.action.openSettings?[" editor.foldingMaximumRegions"]) per abilitarne altre.`,
    "Espandi",
  ...
  "vs/editor/contrib/format/browser/format": [
    "\xC8 stata apportata 1 modifica di formattazione a riga {0}",
    "Sono state apportate {0} modifiche di formattazione a riga {1}",
    "\xC8 stata apportata 1 modifica di formattazione tra le righe {0} e {1}",
  ...
  "vs/platform/list/browser/listService": [
    ...
    "Controlla se gli spostamenti da tastiera per elenchi e alberi vengono attivati semplicemente premendo un tasto. Se \xE8 impostato su `false`, gli spostamenti da tastiera vengono attivati solo durante l'esecuzione del comando `list.toggleKeyboardNavigation`, al quale \xE8 possibile assegnare un tasto di scelta rapida.",
