 ...
 *-----------------------------------------------------------------------------*/
define("vs/basic-languages/freemarker2/freemarker2", [
  "require",
  "require"
], require => {
  var moduleExports = (() => {
    ...
    var m = t => s(t, "__esModule", { value: !0 });
    var w = (t =>
    ...
    var h = (t, n) => () => (
      ...
      I = (t => (n, i) =>
        (t && t.get(n)) || ((i = d(m({}), n, 1)), t && t.set(n, i), i))(
      ...
      return {
        ...
        tokenizer: {
            ...
            [
              /(r?)(['"])/,
              {
                cases: {
                  ...
                  "'": [
                    { token: "source" },
                    { token: "string", next: e("@singleString__id__") }
                  ],
                  '"': [
                    { token: "source" },
                    { token: "string", next: e("@doubleString__id__") }
                  ]
                }
              }
            ],
          ...
          [e("no_space_expression_end_token__id__")]: [
            [
              /(?:@blank)+/,
              { token: "", switchTo: e("@fmExpression__id__.directive") }
            ]
          ],
