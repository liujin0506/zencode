...
define("vs/language/html/htmlMode", ["require", "require"], require => {
  var moduleExports = (() => {
    ...
    var un = (n, t) => () => (
      ...
      cn = (n => (t, i) =>
        (n && n.get(t)) || ((i = q(le({}), t, 1)), n && n.set(t, i), i))(
    ...
    (function(n) {
      ...
      function i(r) {
        var e = r;
        return (
          s.objectLiteral(e) && s.uinteger(e.line) && s.uinteger(e.character)
        );
      }
      n.is = i;
    })(x || (x = {}));
    ...
    (function(n) {
      function t(r, e, o, a) {
        if (s.uinteger(r) && s.uinteger(e) && s.uinteger(o) && s.uinteger(a))
    ...
    (function(n) {
      ...
      function i(r) {
        ...
        return (
          ...
          (v.is(e.originSelectionRange) || s.undefined(e.originSelectionRange))
        );
      }
      n.is = i;
    })(he || (he = {}));
    ...
    (function(n) {
      ...
      function i(r) {
        ...
        return (
          ...
          s.uinteger(e.startLine) &&
          (s.undefined(e.startCharacter) || s.uinteger(e.startCharacter)) &&
          (s.undefined(e.endCharacter) || s.uinteger(e.endCharacter)) &&
    ...
    (function(n) {
      ...
      function i(r) {
        ...
        return (
          ...
          (s.integer(o.code) || s.string(o.code) || s.undefined(o.code)) &&
    ...
    (function(n) {
      ...
      function e(o) {
        var a = o;
        return s.objectLiteral(a) && s.string(a.newText) && v.is(a.range);
      }
      n.is = e;
    })(_ || (_ = {}));
    var R;
    (function(n) {
      ...
      function i(r) {
        ...
        return (
          ...
          s.objectLiteral(e) &&
          s.string(e.label) &&
          (s.boolean(e.needsConfirmation) || e.needsConfirmation === void 0) &&
    ...
    (function(n) {
      ...
      function e(o) {
        var a = o;
        return _.is(a) && (R.is(a.annotationId) || T.is(a.annotationId));
      }
      n.is = e;
    })(I || (I = {}));
    var Y;
    (function(n) {
      ...
      function i(r) {
        var e = r;
        return s.defined(e) && Z.is(e.textDocument) && Array.isArray(e.edits);
      }
      n.is = i;
    })(Y || (Y = {}));
    var S;
        ...
        return (
          ...
          (r.documentChanges === void 0 ||
            r.documentChanges.every(function(e) {
              return s.string(e.kind) ? S.is(e) || F.is(e) || M.is(e) : Y.is(e);
            }))
        );
      }
      n.is = t;
          ...
          (this._textEditChanges = Object.create(null)),
            t !== void 0
              ? ((this._workspaceEdit = t),
                t.documentChanges
                  ? ((this._changeAnnotations = new Ie(t.changeAnnotations)),
                    (t.changeAnnotations = this._changeAnnotations.all()),
                    t.documentChanges.forEach(function(r) {
                      if (Y.is(r)) {
                        var e = new Q(r.edits, i._changeAnnotations);
        ...
        return (
          ...
          (n.prototype.createFile = function(t, i, r) {
            ...
            if (
              (e === void 0
                ? (o = S.create(t, r))
                : ((a = T.is(e) ? e : this._changeAnnotations.manage(e)),
                  (o = S.create(t, r, a))),
              this._workspaceEdit.documentChanges.push(o),
              a !== void 0)
            )
    ...
    (function(n) {
      ...
      function i(r) {
        var e = r;
        return e && s.string(e.newText) && v.is(e.insert) && v.is(e.replace);
      }
      n.is = i;
    })(Ee || (Ee = {}));
    var Re;
    ...
    (function(n) {
      ...
      function i(r) {
        ...
        return (
          s.string(e) ||
          (s.objectLiteral(e) && s.string(e.language) && s.string(e.value))
        );
      }
      n.is = i;
    })(ne || (ne = {}));
    ...
    (function(n) {
      function t(r, e, o, a, u, l) {
        var f = { name: r, detail: e, kind: o, range: a, selectionRange: u };
    ...
    (function(n) {
      ...
      function i(r) {
        ...
        return (
          e &&
          s.string(e.title) &&
          (e.diagnostics === void 0 || s.typedArray(e.diagnostics, J.is)) &&
    ...
    (function(n) {
      ...
      function i(r) {
        var e = r;
        return (
          s.defined(e) && s.uinteger(e.tabSize) && s.boolean(e.insertSpaces)
        );
      }
      n.is = i;
    })(Ne || (Ne = {}));
        ...
        for (
          var u = o.getText(),
            l = e(a, function(w, B) {
              ...
              return ce === 0
                ? w.range.start.character - B.range.start.character
                : ce;
            }),
            f = u.length,
            g = l.length - 1;
          ...
          if (c <= f)
            u = u.substring(0, k) + h.newText + u.substring(c, u.length);
        ...
        let e = a => {
            ...
            (this._listener[a.uri.toString()] = a.onDidChangeContent(() => {
              window.clearTimeout(l),
                (l = window.setTimeout(() => this._doValidate(a.uri, u), 500));
            })),
              ...
              f = a.items.map(g => {
                ...
                return (
                  ...
                  g.additionalTextEdits &&
                    (h.additionalTextEdits = g.additionalTextEdits.map(D)),
...
` +
    ...
    var K = class {
      ...
      provideDocumentHighlights(t, i, r) {
        ...
        return this._worker(e)
          ...
          .then(o => {
            if (!!o)
              return o.map(a => ({ range: y(a.range), kind: In(a.kind) }));
          });
      }
    };
    function In(n) {
    ...
    function _n(n) {
      ...
      for (let i in n.changes) {
        ...
        for (let e of n.changes[i])
          t.push({ resource: r, edit: { range: y(e.range), text: e.newText } });
      }
      return { edits: t };
    }
    var j = class {
    ...
    var Ye = class {
        ...
        provideColorPresentations(t, i, r) {
          ...
          return this._worker(e)
            .then(o =>
              o.getColorPresentations(e.toString(), i.color, ue(i.range))
            )
            .then(o => {
              if (!!o)
                return o.map(a => {
                  let u = { label: a.label };
                  return (
                    a.textEdit && (u.textEdit = D(a.textEdit)),
                    a.additionalTextEdits &&
                      (u.additionalTextEdits = a.additionalTextEdits.map(D)),
                    u
                  );
                });
            });
        ...
        provideFoldingRanges(t, i, r) {
          ...
          return this._worker(e)
            ...
            .then(o => {
              if (!!o)
                return o.map(a => {
                  let u = { start: a.startLine + 1, end: a.endLine + 1 };
                  return typeof a.kind < "u" && (u.kind = bn(a.kind)), u;
                });
            });
        }
      };
        ...
        return this._worker(e)
          ...
          .then(o => {
            if (!!o)
              return o.map(a => {
                let u = [];
                for (; a; ) u.push({ range: y(a.range) }), (a = a.parent);
                return u;
              });
          });
      }
    ...
    function En(n) {
      ...
      d.languages.registerCompletionItemProvider(r, new de(i)),
        ...
        r === "html" &&
          (d.languages.registerDocumentFormattingEditProvider(r, new N(i)),
          d.languages.registerDocumentRangeFormattingEditProvider(r, new V(i)));
    }
    function Rn(n) {
      let t = [],
        i = [],
      ...
      function o() {
        ...
        en(i),
          u.completionItems &&
            i.push(d.languages.registerCompletionItemProvider(a, new de(e))),
          u.hovers && i.push(d.languages.registerHoverProvider(a, new H(e))),
          u.documentHighlights &&
            i.push(d.languages.registerDocumentHighlightProvider(a, new K(e))),
          u.links && i.push(d.languages.registerLinkProvider(a, new O(e))),
          u.documentSymbols &&
            i.push(d.languages.registerDocumentSymbolProvider(a, new j(e))),
          u.rename && i.push(d.languages.registerRenameProvider(a, new U(e))),
          u.foldingRanges &&
            i.push(d.languages.registerFoldingRangeProvider(a, new z(e))),
          u.selectionRanges &&
            i.push(d.languages.registerSelectionRangeProvider(a, new X(e))),
          u.documentFormattingEdits &&
            i.push(
              d.languages.registerDocumentFormattingEditProvider(a, new N(e))
            ),
